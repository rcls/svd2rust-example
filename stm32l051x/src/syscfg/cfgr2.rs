...
#[doc = "Field `FWDISEN` reader - Firewall disable bit"]
pub struct FWDISEN_R(crate::FieldReader<bool, bool>);
impl FWDISEN_R {
    pub(crate) fn new(bits: bool) -> Self {
        FWDISEN_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for FWDISEN_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
#[doc = "Field `FWDISEN` writer - Firewall disable bit"]
