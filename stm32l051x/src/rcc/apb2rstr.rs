...
#[doc = "Field `TM12RST` reader - TIM22 timer reset"]
pub struct TM12RST_R(crate::FieldReader<bool, bool>);
impl TM12RST_R {
    pub(crate) fn new(bits: bool) -> Self {
        TM12RST_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for TM12RST_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
#[doc = "Field `TM12RST` writer - TIM22 timer reset"]
pub struct TM12RST_W<'a> {
    w: &'a mut W,
}
impl<'a> TM12RST_W<'a> {
    #[doc = r"Sets the field bit"]
...
pub struct TIM21RST_R(crate::FieldReader<bool, bool>);
impl TIM21RST_R {
    pub(crate) fn new(bits: bool) -> Self {
        TIM21RST_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for TIM21RST_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
impl R {
    ...
    #[inline(always)]
    pub fn tm12rst(&self) -> TM12RST_R {
        TM12RST_R::new(((self.bits >> 5) & 0x01) != 0)
    }
...
impl W {
    ...
    #[doc = "Bit 5 - TIM22 timer reset"]
    #[inline(always)]
    pub fn tm12rst(&mut self) -> TM12RST_W {
        TM12RST_W { w: self }
    }
    #[doc = "Bit 2 - TIM21 timer reset"]
    #[inline(always)]
