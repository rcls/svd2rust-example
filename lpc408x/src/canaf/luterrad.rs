...
pub struct R(crate::R<LUTERRAD_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<LUTERRAD_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<LUTERRAD_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<LUTERRAD_SPEC>) -> Self {
        R(reader)
    }
}
...
pub struct LUTERRAD_R(crate::FieldReader<u16, u16>);
impl LUTERRAD_R {
    pub(crate) fn new(bits: u16) -> Self {
        LUTERRAD_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for LUTERRAD_R {
...
#[doc = "LUT Error Address register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [luterrad](index.html) module"]
