...
pub struct R(crate::R<RTC_AUXEN_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RTC_AUXEN_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RTC_AUXEN_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RTC_AUXEN_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `RTC_AUXEN` writer"]
pub struct W(crate::W<RTC_AUXEN_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<RTC_AUXEN_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<RTC_AUXEN_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<RTC_AUXEN_SPEC>) -> Self {
        W(writer)
    }
}
...
pub struct RTC_OSCFEN_R(crate::FieldReader<bool, bool>);
impl RTC_OSCFEN_R {
    pub(crate) fn new(bits: bool) -> Self {
        RTC_OSCFEN_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for RTC_OSCFEN_R {
