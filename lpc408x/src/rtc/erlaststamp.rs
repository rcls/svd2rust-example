...
pub struct R(crate::R<ERLASTSTAMP_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<ERLASTSTAMP_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<ERLASTSTAMP_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<ERLASTSTAMP_SPEC>) -> Self {
        R(reader)
    }
}
