...
pub struct R(crate::R<TXRATE_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TXRATE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TXRATE_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TXRATE_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TXRATE` writer"]
pub struct W(crate::W<TXRATE_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TXRATE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TXRATE_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TXRATE_SPEC>) -> Self {
        W(writer)
    }
}
