...
pub struct R(crate::R<TDA_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TDA_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TDA_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TDA_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TDA%s` writer"]
pub struct W(crate::W<TDA_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TDA_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TDA_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TDA_SPEC>) -> Self {
        W(writer)
    }
}
