...
pub struct R(crate::R<GSR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<GSR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<GSR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<GSR_SPEC>) -> Self {
        R(reader)
    }
}
...
pub struct DOS_R(crate::FieldReader<bool, DOS_A>);
impl DOS_R {
    pub(crate) fn new(bits: bool) -> Self {
        DOS_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
impl core::ops::Deref for DOS_R {
    type Target = crate::FieldReader<bool, DOS_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
pub struct TBS_R(crate::FieldReader<bool, TBS_A>);
impl TBS_R {
    pub(crate) fn new(bits: bool) -> Self {
        TBS_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
impl core::ops::Deref for TBS_R {
    type Target = crate::FieldReader<bool, TBS_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
pub struct TCS_R(crate::FieldReader<bool, TCS_A>);
impl TCS_R {
    pub(crate) fn new(bits: bool) -> Self {
...
impl core::ops::Deref for TCS_R {
    type Target = crate::FieldReader<bool, TCS_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
pub struct ES_R(crate::FieldReader<bool, ES_A>);
impl ES_R {
    pub(crate) fn new(bits: bool) -> Self {
        ES_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
impl core::ops::Deref for ES_R {
    type Target = crate::FieldReader<bool, ES_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
