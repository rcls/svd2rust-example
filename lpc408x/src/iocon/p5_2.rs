...
pub struct R(crate::R<P5_2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<P5_2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<P5_2_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<P5_2_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `P5_2` writer"]
pub struct W(crate::W<P5_2_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<P5_2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<P5_2_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<P5_2_SPEC>) -> Self {
        W(writer)
    }
}
