#[doc = "Register `P2_7` reader"]
pub struct R(crate::R<P2_7_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<P2_7_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<P2_7_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<P2_7_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `P2_7` writer"]
pub struct W(crate::W<P2_7_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<P2_7_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<P2_7_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<P2_7_SPEC>) -> Self {
        W(writer)
    }
}
...
pub enum FUNC_A {
    ...
    U1_RTS = 2,
    #[doc = "5: Chip select output for SPIFI."]
    SPIFI_CS = 5,
    #[doc = "6: LCD data."]
    LCD_VD_1 = 6,
    #[doc = "7: LCD data."]
...
#[doc = "Field `FUNC` reader - Selects pin function for pin P2\\[7\\]"]
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> Option<FUNC_A> {
        match self.bits {
            0 => Some(FUNC_A::P2_7),
            1 => Some(FUNC_A::CAN_RD2),
            2 => Some(FUNC_A::U1_RTS),
            5 => Some(FUNC_A::SPIFI_CS),
            6 => Some(FUNC_A::LCD_VD_1),
            7 => Some(FUNC_A::LCD_VD_5),
            _ => None,
        }
    }
    ...
    #[doc = "Checks if the value of the field is `SPIFI_CS`"]
    #[inline(always)]
    pub fn is_spifi_cs(&self) -> bool {
        **self == FUNC_A::SPIFI_CS
    }
...
#[doc = "Field `FUNC` writer - Selects pin function for pin P2\\[7\\]"]
pub struct FUNC_W<'a> {
    w: &'a mut W,
}
impl<'a> FUNC_W<'a> {
    ...
    #[doc = "Chip select output for SPIFI."]
    #[inline(always)]
    pub fn spifi_cs(self) -> &'a mut W {
        self.variant(FUNC_A::SPIFI_CS)
    }
    #[doc = "LCD data."]
    #[inline(always)]
...
#[doc = "I/O configuration register for pin P2\\[7\\]\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [p2_7](index.html) module"]
pub struct P2_7_SPEC;
impl crate::RegisterSpec for P2_7_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [p2_7::R](R) reader structure"]
impl crate::Readable for P2_7_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [p2_7::W](W) writer structure"]
impl crate::Writable for P2_7_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets P2_7 to value 0x30"]
impl crate::Resettable for P2_7_SPEC {
    #[inline(always)]
