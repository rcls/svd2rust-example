...
pub struct R(crate::R<P0_5_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<P0_5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<P0_5_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<P0_5_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `P0_5` writer"]
pub struct W(crate::W<P0_5_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<P0_5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<P0_5_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<P0_5_SPEC>) -> Self {
        W(writer)
    }
}
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> Option<FUNC_A> {
        match self.bits {
            0 => Some(FUNC_A::P0_5),
            1 => Some(FUNC_A::I2S_RX_WS),
            2 => Some(FUNC_A::CAN_TD2),
            3 => Some(FUNC_A::T2_CAP1),
            5 => Some(FUNC_A::CMP_RESET),
            7 => Some(FUNC_A::LCD_VD_1),
            _ => None,
        }
    }
    ...
    #[doc = "Checks if the value of the field is `CMP_RESET`"]
    #[inline(always)]
    pub fn is_cmp_reset(&self) -> bool {
        **self == FUNC_A::CMP_RESET
    }
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn cmp_reset(self) -> &'a mut W {
        self.variant(FUNC_A::CMP_RESET)
    }
    #[doc = "LCD data."]
    #[inline(always)]
