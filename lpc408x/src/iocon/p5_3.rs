...
pub struct R(crate::R<P5_3_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<P5_3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<P5_3_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<P5_3_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `P5_3` writer"]
pub struct W(crate::W<P5_3_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<P5_3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<P5_3_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<P5_3_SPEC>) -> Self {
        W(writer)
    }
}
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> Option<FUNC_A> {
        match self.bits {
            0 => Some(FUNC_A::P5_3),
            4 => Some(FUNC_A::U4_RXD),
            5 => Some(FUNC_A::I2C0_SCL),
            _ => None,
        }
    }
