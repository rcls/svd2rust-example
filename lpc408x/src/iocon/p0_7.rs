#[doc = "Register `P0_7` reader"]
pub struct R(crate::R<P0_7_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<P0_7_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<P0_7_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<P0_7_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `P0_7` writer"]
pub struct W(crate::W<P0_7_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<P0_7_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<P0_7_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<P0_7_SPEC>) -> Self {
        W(writer)
    }
}
...
pub enum FUNC_A {
    ...
    RTC_EV0 = 4,
    #[doc = "5: Comparator reference voltage."]
    CMP_VREF = 5,
    #[doc = "7: LCD data."]
    LCD_VD_9 = 7,
}
...
#[doc = "Field `FUNC` reader - Selects pin function for pin P0\\[7\\]"]
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> Option<FUNC_A> {
        match self.bits {
            0 => Some(FUNC_A::P0_7),
            1 => Some(FUNC_A::I2S_TX_SCK),
            2 => Some(FUNC_A::SSP1_SCK),
            3 => Some(FUNC_A::T2_MAT1),
            4 => Some(FUNC_A::RTC_EV0),
            5 => Some(FUNC_A::CMP_VREF),
            7 => Some(FUNC_A::LCD_VD_9),
            _ => None,
        }
    }
    ...
    #[doc = "Checks if the value of the field is `CMP_VREF`"]
    #[inline(always)]
    pub fn is_cmp_vref(&self) -> bool {
        **self == FUNC_A::CMP_VREF
    }
...
#[doc = "Field `FUNC` writer - Selects pin function for pin P0\\[7\\]"]
pub struct FUNC_W<'a> {
    w: &'a mut W,
}
impl<'a> FUNC_W<'a> {
    ...
    #[doc = "Comparator reference voltage."]
    #[inline(always)]
    pub fn cmp_vref(self) -> &'a mut W {
        self.variant(FUNC_A::CMP_VREF)
    }
    #[doc = "LCD data."]
    #[inline(always)]
...
#[doc = "Field `FILTER` reader - Glitch filter control"]
...
#[doc = "Field `FILTER` writer - Glitch filter control"]
...
#[doc = "I/O configuration register for pin P0\\[7\\]\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [p0_7](index.html) module"]
pub struct P0_7_SPEC;
impl crate::RegisterSpec for P0_7_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [p0_7::R](R) reader structure"]
impl crate::Readable for P0_7_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [p0_7::W](W) writer structure"]
impl crate::Writable for P0_7_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets P0_7 to value 0xa0"]
impl crate::Resettable for P0_7_SPEC {
    #[inline(always)]
