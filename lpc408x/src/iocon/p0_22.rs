...
pub struct R(crate::R<P0_22_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<P0_22_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<P0_22_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<P0_22_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `P0_22` writer"]
pub struct W(crate::W<P0_22_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<P0_22_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<P0_22_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<P0_22_SPEC>) -> Self {
        W(writer)
    }
}
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> Option<FUNC_A> {
        match self.bits {
            0 => Some(FUNC_A::P0_22),
            1 => Some(FUNC_A::U1_RTS),
            2 => Some(FUNC_A::SD_DAT_0),
            3 => Some(FUNC_A::U4_TXD),
            4 => Some(FUNC_A::CAN_TD1),
            5 => Some(FUNC_A::SPIFI_CLK),
            _ => None,
        }
    }
    ...
    #[doc = "Checks if the value of the field is `SPIFI_CLK`"]
    #[inline(always)]
    pub fn is_spifi_clk(&self) -> bool {
        **self == FUNC_A::SPIFI_CLK
    }
}
...
impl<'a> FUNC_W<'a> {
    ...
    #[doc = "Clock output for SPIFI."]
    #[inline(always)]
    pub fn spifi_clk(self) -> &'a mut W {
        self.variant(FUNC_A::SPIFI_CLK)
    }
