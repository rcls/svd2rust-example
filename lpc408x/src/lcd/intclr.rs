...
#[doc = "Field `FUFIC` writer - FIFO underflow interrupt clear. Writing a 1 to this bit clears the FIFO underflow interrupt."]
...
#[doc = "Field `LNBUIC` writer - LCD next address base update interrupt clear. Writing a 1 to this bit clears the LCD next address base update interrupt."]
...
#[doc = "Field `VCOMPIC` writer - Vertical compare interrupt clear. Writing a 1 to this bit clears the vertical compare interrupt."]
...
#[doc = "Field `BERIC` writer - AHB master error interrupt clear. Writing a 1 to this bit clears the AHB master error interrupt."]
