...
pub struct W(crate::W<CNTCON_CLR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CNTCON_CLR_SPEC>;
    #[inline(always)]
...
impl From<crate::W<CNTCON_CLR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CNTCON_CLR_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Count Control clear address\n\nThis register you can [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cntcon_clr](index.html) module"]
