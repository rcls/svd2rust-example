...
#[doc = "Field `DLMSB` reader - The UART4 Divisor Latch MSB Register, along with the U0DLL register, determines the baud rate of the UART4."]
...
#[doc = "Field `DLMSB` writer - The UART4 Divisor Latch MSB Register, along with the U0DLL register, determines the baud rate of the UART4."]
...
#[doc = "`reset()` method sets DLM to value 0x01"]
