...
#[doc = "Field `DIVADDVAL` reader - Baud Rate generation pre-scaler divisor value. If this field is 0, fractional baud rate generator will not impact the UART4 baud rate."]
...
#[doc = "Field `DIVADDVAL` writer - Baud Rate generation pre-scaler divisor value. If this field is 0, fractional baud rate generator will not impact the UART4 baud rate."]
...
#[doc = "Field `MULVAL` reader - Baud Rate pre-scaler multiplier value. This field must be greater or equal 1 for UART4 to operate properly, regardless of whether the fractional baud rate generator is used or not."]
...
#[doc = "Field `MULVAL` writer - Baud Rate pre-scaler multiplier value. This field must be greater or equal 1 for UART4 to operate properly, regardless of whether the fractional baud rate generator is used or not."]
