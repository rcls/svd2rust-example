...
#[doc = "Field `DLY` reader - Contains the direction control (U4OE) delay value. This register works in conjunction with an 8-bit counter."]
...
#[doc = "Field `DLY` writer - Contains the direction control (U4OE) delay value. This register works in conjunction with an 8-bit counter."]
pub struct DLY_W<'a> {
    w: &'a mut W,
}
impl<'a> DLY_W<'a> {
