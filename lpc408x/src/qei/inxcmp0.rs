...
pub struct R(crate::R<INXCMP0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<INXCMP0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<INXCMP0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<INXCMP0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `INXCMP0` writer"]
pub struct W(crate::W<INXCMP0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<INXCMP0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<INXCMP0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<INXCMP0_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `ICMP0` reader - Index compare value 0."]
pub struct ICMP0_R(crate::FieldReader<u32, u32>);
impl ICMP0_R {
    pub(crate) fn new(bits: u32) -> Self {
        ICMP0_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for ICMP0_R {
