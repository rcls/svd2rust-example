...
pub struct R(crate::R<CMPOS0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CMPOS0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CMPOS0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CMPOS0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CMPOS0` writer"]
pub struct W(crate::W<CMPOS0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CMPOS0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CMPOS0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CMPOS0_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `PCMP0` reader - Position compare value 0."]
pub struct PCMP0_R(crate::FieldReader<u32, u32>);
impl PCMP0_R {
    pub(crate) fn new(bits: u32) -> Self {
        PCMP0_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for PCMP0_R {
