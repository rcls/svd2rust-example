...
pub struct HVLVD1_EDGE_SEL_R(crate::FieldReader<u8, HVLVD1_EDGE_SEL_A>);
impl HVLVD1_EDGE_SEL_R {
    pub(crate) fn new(bits: u8) -> Self {
        HVLVD1_EDGE_SEL_R(crate::FieldReader::new(bits))
    }
...
impl core::ops::Deref for HVLVD1_EDGE_SEL_R {
    type Target = crate::FieldReader<u8, HVLVD1_EDGE_SEL_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
