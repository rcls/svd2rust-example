...
pub struct HVLVD1_TRIPSEL_R(crate::FieldReader<u8, u8>);
impl HVLVD1_TRIPSEL_R {
    pub(crate) fn new(bits: u8) -> Self {
        HVLVD1_TRIPSEL_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for HVLVD1_TRIPSEL_R {
...
pub struct HVLVD1_SRCSEL_R(crate::FieldReader<u8, HVLVD1_SRCSEL_A>);
impl HVLVD1_SRCSEL_R {
    pub(crate) fn new(bits: u8) -> Self {
        HVLVD1_SRCSEL_R(crate::FieldReader::new(bits))
    }
...
impl core::ops::Deref for HVLVD1_SRCSEL_R {
    type Target = crate::FieldReader<u8, HVLVD1_SRCSEL_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
pub struct HVLVD1_EN_R(crate::FieldReader<bool, bool>);
impl HVLVD1_EN_R {
    pub(crate) fn new(bits: bool) -> Self {
        HVLVD1_EN_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for HVLVD1_EN_R {
