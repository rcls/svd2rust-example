...
to configure the desired path. Some paths may have FLL or PLL available (product-specific), and the control and bypass mux selections of these are in other registers. Configure the FLL using CLK_FLL_CONFIG register. Configure a PLL using the related CLK_PLL_CONFIG\\[k\\]
register. Note that not all products support all clock sources. Selecting a clock source that is not supported will result in undefined behavior."]
pub struct ROOT_MUX_R(crate::FieldReader<u8, ROOT_MUX_A>);
impl ROOT_MUX_R {
    pub(crate) fn new(bits: u8) -> Self {
        ROOT_MUX_R(crate::FieldReader::new(bits))
    }
...
impl core::ops::Deref for ROOT_MUX_R {
    type Target = crate::FieldReader<u8, ROOT_MUX_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
pub struct ROOT_DIV_R(crate::FieldReader<u8, ROOT_DIV_A>);
impl ROOT_DIV_R {
    pub(crate) fn new(bits: u8) -> Self {
        ROOT_DIV_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
impl core::ops::Deref for ROOT_DIV_R {
    type Target = crate::FieldReader<u8, ROOT_DIV_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
