...
pub struct RESET_CSV_HF_LOSS_R(crate::FieldReader<u16, u16>);
impl RESET_CSV_HF_LOSS_R {
    pub(crate) fn new(bits: u16) -> Self {
        RESET_CSV_HF_LOSS_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for RESET_CSV_HF_LOSS_R {
...
pub struct RESET_CSV_HF_FREQ_R(crate::FieldReader<u16, u16>);
impl RESET_CSV_HF_FREQ_R {
    pub(crate) fn new(bits: u16) -> Self {
        RESET_CSV_HF_FREQ_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for RESET_CSV_HF_FREQ_R {
    type Target = crate::FieldReader<u16, u16>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
