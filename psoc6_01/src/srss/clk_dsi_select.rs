...
pub struct DSI_MUX_R(crate::FieldReader<u8, DSI_MUX_A>);
impl DSI_MUX_R {
    pub(crate) fn new(bits: u8) -> Self {
        DSI_MUX_R(crate::FieldReader::new(bits))
    }
...
impl core::ops::Deref for DSI_MUX_R {
    type Target = crate::FieldReader<u8, DSI_MUX_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
