...
pub struct HVLVD1_OFSTRIM_R(crate::FieldReader<u8, u8>);
impl HVLVD1_OFSTRIM_R {
    pub(crate) fn new(bits: u8) -> Self {
        HVLVD1_OFSTRIM_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for HVLVD1_OFSTRIM_R {
...
pub struct HVLVD1_ITRIM_R(crate::FieldReader<u8, u8>);
impl HVLVD1_ITRIM_R {
    pub(crate) fn new(bits: u8) -> Self {
        HVLVD1_ITRIM_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for HVLVD1_ITRIM_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
