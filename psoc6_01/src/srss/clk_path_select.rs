...
pub struct PATH_MUX_R(crate::FieldReader<u8, PATH_MUX_A>);
impl PATH_MUX_R {
    pub(crate) fn new(bits: u8) -> Self {
        PATH_MUX_R(crate::FieldReader::new(bits))
    }
...
impl core::ops::Deref for PATH_MUX_R {
    type Target = crate::FieldReader<u8, PATH_MUX_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
