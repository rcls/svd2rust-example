...
pub struct WDT_LOCK_R(crate::FieldReader<u8, WDT_LOCK_A>);
impl WDT_LOCK_R {
    pub(crate) fn new(bits: u8) -> Self {
        WDT_LOCK_R(crate::FieldReader::new(bits))
    }
...
impl core::ops::Deref for WDT_LOCK_R {
    type Target = crate::FieldReader<u8, WDT_LOCK_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
