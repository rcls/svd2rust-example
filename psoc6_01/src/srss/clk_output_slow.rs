...
pub struct SLOW_SEL0_R(crate::FieldReader<u8, SLOW_SEL0_A>);
impl SLOW_SEL0_R {
    pub(crate) fn new(bits: u8) -> Self {
        SLOW_SEL0_R(crate::FieldReader::new(bits))
    }
...
impl core::ops::Deref for SLOW_SEL0_R {
    type Target = crate::FieldReader<u8, SLOW_SEL0_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
pub struct SLOW_SEL1_R(crate::FieldReader<u8, SLOW_SEL1_A>);
impl SLOW_SEL1_R {
    pub(crate) fn new(bits: u8) -> Self {
        SLOW_SEL1_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
impl core::ops::Deref for SLOW_SEL1_R {
    type Target = crate::FieldReader<u8, SLOW_SEL1_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
