...
pub struct FLL_REF_DIV_R(crate::FieldReader<u16, u16>);
impl FLL_REF_DIV_R {
    pub(crate) fn new(bits: u16) -> Self {
        FLL_REF_DIV_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for FLL_REF_DIV_R {
...
pub struct LOCK_TOL_R(crate::FieldReader<u16, u16>);
impl LOCK_TOL_R {
    pub(crate) fn new(bits: u16) -> Self {
        LOCK_TOL_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for LOCK_TOL_R {
    type Target = crate::FieldReader<u16, u16>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
