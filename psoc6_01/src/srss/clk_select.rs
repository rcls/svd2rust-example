...
pub struct LFCLK_SEL_R(crate::FieldReader<u8, LFCLK_SEL_A>);
impl LFCLK_SEL_R {
    pub(crate) fn new(bits: u8) -> Self {
        LFCLK_SEL_R(crate::FieldReader::new(bits))
    }
...
impl core::ops::Deref for LFCLK_SEL_R {
    type Target = crate::FieldReader<u8, LFCLK_SEL_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
pub struct PUMP_SEL_R(crate::FieldReader<u8, u8>);
impl PUMP_SEL_R {
    pub(crate) fn new(bits: u8) -> Self {
        PUMP_SEL_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for PUMP_SEL_R {
...
pub struct PUMP_DIV_R(crate::FieldReader<u8, PUMP_DIV_A>);
impl PUMP_DIV_R {
    pub(crate) fn new(bits: u8) -> Self {
        PUMP_DIV_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
impl core::ops::Deref for PUMP_DIV_R {
    type Target = crate::FieldReader<u8, PUMP_DIV_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
pub struct PUMP_ENABLE_R(crate::FieldReader<bool, bool>);
impl PUMP_ENABLE_R {
    pub(crate) fn new(bits: bool) -> Self {
        PUMP_ENABLE_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for PUMP_ENABLE_R {
