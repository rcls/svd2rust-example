...
pub struct TIMER_SEL_R(crate::FieldReader<bool, TIMER_SEL_A>);
impl TIMER_SEL_R {
...
impl core::ops::Deref for TIMER_SEL_R {
    type Target = crate::FieldReader<bool, TIMER_SEL_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
pub struct TIMER_HF0_DIV_R(crate::FieldReader<u8, TIMER_HF0_DIV_A>);
impl TIMER_HF0_DIV_R {
    pub(crate) fn new(bits: u8) -> Self {
        TIMER_HF0_DIV_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
impl core::ops::Deref for TIMER_HF0_DIV_R {
    type Target = crate::FieldReader<u8, TIMER_HF0_DIV_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
pub struct TIMER_DIV_R(crate::FieldReader<u8, u8>);
impl TIMER_DIV_R {
    pub(crate) fn new(bits: u8) -> Self {
        TIMER_DIV_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for TIMER_DIV_R {
