...
pub struct FAST_SEL0_R(crate::FieldReader<u8, FAST_SEL0_A>);
impl FAST_SEL0_R {
    pub(crate) fn new(bits: u8) -> Self {
        FAST_SEL0_R(crate::FieldReader::new(bits))
    }
...
impl core::ops::Deref for FAST_SEL0_R {
    type Target = crate::FieldReader<u8, FAST_SEL0_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
pub struct PATH_SEL0_R(crate::FieldReader<u8, u8>);
impl PATH_SEL0_R {
    pub(crate) fn new(bits: u8) -> Self {
        PATH_SEL0_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for PATH_SEL0_R {
...
pub struct HFCLK_SEL0_R(crate::FieldReader<u8, u8>);
impl HFCLK_SEL0_R {
    pub(crate) fn new(bits: u8) -> Self {
        HFCLK_SEL0_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for HFCLK_SEL0_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct FAST_SEL1_R(crate::FieldReader<u8, FAST_SEL1_A>);
impl FAST_SEL1_R {
    pub(crate) fn new(bits: u8) -> Self {
        FAST_SEL1_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
impl core::ops::Deref for FAST_SEL1_R {
    type Target = crate::FieldReader<u8, FAST_SEL1_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
pub struct PATH_SEL1_R(crate::FieldReader<u8, u8>);
impl PATH_SEL1_R {
    pub(crate) fn new(bits: u8) -> Self {
        PATH_SEL1_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for PATH_SEL1_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct HFCLK_SEL1_R(crate::FieldReader<u8, u8>);
impl HFCLK_SEL1_R {
    pub(crate) fn new(bits: u8) -> Self {
        HFCLK_SEL1_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for HFCLK_SEL1_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
