...
pub struct MCWDT_LOCK_R(crate::FieldReader<u8, MCWDT_LOCK_A>);
impl MCWDT_LOCK_R {
    pub(crate) fn new(bits: u8) -> Self {
        MCWDT_LOCK_R(crate::FieldReader::new(bits))
    }
...
impl core::ops::Deref for MCWDT_LOCK_R {
    type Target = crate::FieldReader<u8, MCWDT_LOCK_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
