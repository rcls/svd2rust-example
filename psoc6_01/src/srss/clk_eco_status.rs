...
pub struct ECO_OK_R(crate::FieldReader<bool, bool>);
impl ECO_OK_R {
    pub(crate) fn new(bits: bool) -> Self {
        ECO_OK_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for ECO_OK_R {
...
pub struct ECO_READY_R(crate::FieldReader<bool, bool>);
impl ECO_READY_R {
    pub(crate) fn new(bits: bool) -> Self {
        ECO_READY_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for ECO_READY_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
