...
pub struct RTC_BUSY_R(crate::FieldReader<bool, bool>);
impl RTC_BUSY_R {
    pub(crate) fn new(bits: bool) -> Self {
        RTC_BUSY_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for RTC_BUSY_R {
...
pub struct WCO_OK_R(crate::FieldReader<bool, bool>);
impl WCO_OK_R {
    pub(crate) fn new(bits: bool) -> Self {
        WCO_OK_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for WCO_OK_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
