...
pub struct R(crate::R<ALM1_DATE_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<ALM1_DATE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<ALM1_DATE_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<ALM1_DATE_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `ALM1_DATE` writer"]
pub struct W(crate::W<ALM1_DATE_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<ALM1_DATE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<ALM1_DATE_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<ALM1_DATE_SPEC>) -> Self {
        W(writer)
    }
}
...
pub struct ALM1_DATE_SPEC;
impl crate::RegisterSpec for ALM1_DATE_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [alm1_date::R](R) reader structure"]
impl crate::Readable for ALM1_DATE_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [alm1_date::W](W) writer structure"]
impl crate::Writable for ALM1_DATE_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets ALM1_DATE to value 0x0101"]
impl crate::Resettable for ALM1_DATE_SPEC {
    #[inline(always)]
