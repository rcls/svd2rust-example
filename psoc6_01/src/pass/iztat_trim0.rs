...
pub struct IZTAT_ABS_TRIM_R(crate::FieldReader<u8, u8>);
impl IZTAT_ABS_TRIM_R {
    pub(crate) fn new(bits: u8) -> Self {
        IZTAT_ABS_TRIM_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for IZTAT_ABS_TRIM_R {
