...
pub struct VREF_TEMPCO_TRIM_R(crate::FieldReader<u8, u8>);
impl VREF_TEMPCO_TRIM_R {
    pub(crate) fn new(bits: u8) -> Self {
        VREF_TEMPCO_TRIM_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for VREF_TEMPCO_TRIM_R {
