...
pub struct DATA_COMP_RESULT_R(crate::FieldReader<bool, bool>);
impl DATA_COMP_RESULT_R {
    pub(crate) fn new(bits: bool) -> Self {
        DATA_COMP_RESULT_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for DATA_COMP_RESULT_R {
