...
pub struct TIMER_EXPIRED_R(crate::FieldReader<bool, bool>);
impl TIMER_EXPIRED_R {
    pub(crate) fn new(bits: bool) -> Self {
        TIMER_EXPIRED_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for TIMER_EXPIRED_R {
