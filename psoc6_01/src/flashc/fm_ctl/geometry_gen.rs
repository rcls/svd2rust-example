...
pub struct DNU_0X20_1_R(crate::FieldReader<bool, bool>);
impl DNU_0X20_1_R {
    pub(crate) fn new(bits: bool) -> Self {
        DNU_0X20_1_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for DNU_0X20_1_R {
...
pub struct DNU_0X20_2_R(crate::FieldReader<bool, bool>);
impl DNU_0X20_2_R {
    pub(crate) fn new(bits: bool) -> Self {
        DNU_0X20_2_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for DNU_0X20_2_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct DNU_0X20_3_R(crate::FieldReader<bool, bool>);
impl DNU_0X20_3_R {
    pub(crate) fn new(bits: bool) -> Self {
        DNU_0X20_3_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for DNU_0X20_3_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
