...
pub struct COL_ADDR_START_R(crate::FieldReader<u16, u16>);
impl COL_ADDR_START_R {
    pub(crate) fn new(bits: u16) -> Self {
        COL_ADDR_START_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for COL_ADDR_START_R {
...
pub struct ROW_ADDR_START_R(crate::FieldReader<u16, u16>);
impl ROW_ADDR_START_R {
    pub(crate) fn new(bits: u16) -> Self {
        ROW_ADDR_START_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for ROW_ADDR_START_R {
    type Target = crate::FieldReader<u16, u16>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
