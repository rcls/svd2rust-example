...
pub struct SLEEPING_R(crate::FieldReader<bool, bool>);
impl SLEEPING_R {
    pub(crate) fn new(bits: bool) -> Self {
        SLEEPING_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SLEEPING_R {
...
pub struct PWR_DONE_R(crate::FieldReader<bool, bool>);
impl PWR_DONE_R {
    pub(crate) fn new(bits: bool) -> Self {
        PWR_DONE_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for PWR_DONE_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
