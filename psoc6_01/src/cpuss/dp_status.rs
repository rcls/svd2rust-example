...
pub struct SWJ_CONNECTED_R(crate::FieldReader<bool, bool>);
impl SWJ_CONNECTED_R {
    pub(crate) fn new(bits: bool) -> Self {
        SWJ_CONNECTED_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SWJ_CONNECTED_R {
...
pub struct SWJ_DEBUG_EN_R(crate::FieldReader<bool, bool>);
impl SWJ_DEBUG_EN_R {
    pub(crate) fn new(bits: bool) -> Self {
        SWJ_DEBUG_EN_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SWJ_DEBUG_EN_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct SWJ_JTAG_SEL_R(crate::FieldReader<bool, bool>);
impl SWJ_JTAG_SEL_R {
    pub(crate) fn new(bits: bool) -> Self {
        SWJ_JTAG_SEL_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SWJ_JTAG_SEL_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
