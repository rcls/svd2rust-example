...
pub struct SFP_READY_R(crate::FieldReader<bool, bool>);
impl SFP_READY_R {
    pub(crate) fn new(bits: bool) -> Self {
        SFP_READY_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SFP_READY_R {
...
pub struct SFP_FAIL_R(crate::FieldReader<bool, bool>);
impl SFP_FAIL_R {
    pub(crate) fn new(bits: bool) -> Self {
        SFP_FAIL_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SFP_FAIL_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
