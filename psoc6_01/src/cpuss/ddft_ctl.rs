...
pub struct DDFT_OUT0_SEL_R(crate::FieldReader<u8, u8>);
impl DDFT_OUT0_SEL_R {
    pub(crate) fn new(bits: u8) -> Self {
        DDFT_OUT0_SEL_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for DDFT_OUT0_SEL_R {
...
(Retention control for SRAM0 macro0) 21: mmio_ram0_ctl1_isolate_n\\[0\\]
(Isolation control for SRAM0 macro0)"]
pub struct DDFT_OUT1_SEL_R(crate::FieldReader<u8, u8>);
impl DDFT_OUT1_SEL_R {
    pub(crate) fn new(bits: u8) -> Self {
        DDFT_OUT1_SEL_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for DDFT_OUT1_SEL_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
