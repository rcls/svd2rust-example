...
pub struct SLOW_INT_DIV_R(crate::FieldReader<u8, u8>);
impl SLOW_INT_DIV_R {
    pub(crate) fn new(bits: u8) -> Self {
        SLOW_INT_DIV_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SLOW_INT_DIV_R {
...
pub struct PERI_INT_DIV_R(crate::FieldReader<u8, u8>);
impl PERI_INT_DIV_R {
    pub(crate) fn new(bits: u8) -> Self {
        PERI_INT_DIV_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for PERI_INT_DIV_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
