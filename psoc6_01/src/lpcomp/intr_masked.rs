...
pub struct COMP0_MASKED_R(crate::FieldReader<bool, bool>);
impl COMP0_MASKED_R {
    pub(crate) fn new(bits: bool) -> Self {
        COMP0_MASKED_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for COMP0_MASKED_R {
...
pub struct COMP1_MASKED_R(crate::FieldReader<bool, bool>);
impl COMP1_MASKED_R {
    pub(crate) fn new(bits: bool) -> Self {
        COMP1_MASKED_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for COMP1_MASKED_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
