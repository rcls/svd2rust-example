#[doc = "Register `SEQ_PROGRAM_CTL_1` reader"]
pub struct R(crate::R<SEQ_PROGRAM_CTL_1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SEQ_PROGRAM_CTL_1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SEQ_PROGRAM_CTL_1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SEQ_PROGRAM_CTL_1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SEQ_PROGRAM_CTL_1` writer"]
pub struct W(crate::W<SEQ_PROGRAM_CTL_1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SEQ_PROGRAM_CTL_1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SEQ_PROGRAM_CTL_1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SEQ_PROGRAM_CTL_1_SPEC>) -> Self {
        W(writer)
    }
}
...
pub struct SEQ_PROGRAM_CTL_1_SPEC;
impl crate::RegisterSpec for SEQ_PROGRAM_CTL_1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [seq_program_ctl_1::R](R) reader structure"]
impl crate::Readable for SEQ_PROGRAM_CTL_1_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [seq_program_ctl_1::W](W) writer structure"]
impl crate::Writable for SEQ_PROGRAM_CTL_1_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets SEQ_PROGRAM_CTL_1 to value 0x0022_0020"]
impl crate::Resettable for SEQ_PROGRAM_CTL_1_SPEC {
    #[inline(always)]
