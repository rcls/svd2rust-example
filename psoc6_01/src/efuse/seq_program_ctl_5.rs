...
pub struct R(crate::R<SEQ_PROGRAM_CTL_5_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SEQ_PROGRAM_CTL_5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SEQ_PROGRAM_CTL_5_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SEQ_PROGRAM_CTL_5_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SEQ_PROGRAM_CTL_5` writer"]
pub struct W(crate::W<SEQ_PROGRAM_CTL_5_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SEQ_PROGRAM_CTL_5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SEQ_PROGRAM_CTL_5_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SEQ_PROGRAM_CTL_5_SPEC>) -> Self {
        W(writer)
    }
}
