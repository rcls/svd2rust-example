...
pub struct SSEL_CONTINUOUS_R(crate::FieldReader<bool, bool>);
impl SSEL_CONTINUOUS_R {
    pub(crate) fn new(bits: bool) -> Self {
        SSEL_CONTINUOUS_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SSEL_CONTINUOUS_R {
...
pub struct SSEL_R(crate::FieldReader<u8, u8>);
impl SSEL_R {
    pub(crate) fn new(bits: u8) -> Self {
