...
pub struct R(crate::R<INTR_SPI_EC_MASK_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<INTR_SPI_EC_MASK_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<INTR_SPI_EC_MASK_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<INTR_SPI_EC_MASK_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `INTR_SPI_EC_MASK` writer"]
pub struct W(crate::W<INTR_SPI_EC_MASK_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<INTR_SPI_EC_MASK_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<INTR_SPI_EC_MASK_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<INTR_SPI_EC_MASK_SPEC>) -> Self {
        W(writer)
    }
}
