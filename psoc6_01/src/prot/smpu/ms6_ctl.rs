...
pub struct R(crate::R<MS6_CTL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<MS6_CTL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<MS6_CTL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<MS6_CTL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `MS6_CTL` writer"]
pub struct W(crate::W<MS6_CTL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<MS6_CTL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<MS6_CTL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<MS6_CTL_SPEC>) -> Self {
        W(writer)
    }
}
