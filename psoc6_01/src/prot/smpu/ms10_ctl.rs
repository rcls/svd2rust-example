#[doc = "Register `MS10_CTL` reader"]
pub struct R(crate::R<MS10_CTL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<MS10_CTL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<MS10_CTL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<MS10_CTL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `MS10_CTL` writer"]
pub struct W(crate::W<MS10_CTL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<MS10_CTL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<MS10_CTL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<MS10_CTL_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Master 10 protection context control\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [ms10_ctl](index.html) module"]
pub struct MS10_CTL_SPEC;
impl crate::RegisterSpec for MS10_CTL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [ms10_ctl::R](R) reader structure"]
impl crate::Readable for MS10_CTL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [ms10_ctl::W](W) writer structure"]
impl crate::Writable for MS10_CTL_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets MS10_CTL to value 0x0303"]
impl crate::Resettable for MS10_CTL_SPEC {
    #[inline(always)]
