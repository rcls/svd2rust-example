...
pub struct R(crate::R<CRYPTO_OUTPUT3_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CRYPTO_OUTPUT3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CRYPTO_OUTPUT3_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CRYPTO_OUTPUT3_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CRYPTO_OUTPUT3` writer"]
pub struct W(crate::W<CRYPTO_OUTPUT3_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CRYPTO_OUTPUT3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CRYPTO_OUTPUT3_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CRYPTO_OUTPUT3_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Cryptography output 3\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [crypto_output3](index.html) module"]
pub struct CRYPTO_OUTPUT3_SPEC;
impl crate::RegisterSpec for CRYPTO_OUTPUT3_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [crypto_output3::R](R) reader structure"]
impl crate::Readable for CRYPTO_OUTPUT3_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [crypto_output3::W](W) writer structure"]
impl crate::Writable for CRYPTO_OUTPUT3_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets CRYPTO_OUTPUT3 to value 0"]
impl crate::Resettable for CRYPTO_OUTPUT3_SPEC {
    #[inline(always)]
