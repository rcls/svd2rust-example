...
pub struct B_CLOCK_INV_R(crate::FieldReader<bool, B_CLOCK_INV_A>);
impl B_CLOCK_INV_R {
    pub(crate) fn new(bits: bool) -> Self {
        B_CLOCK_INV_R(crate::FieldReader::new(bits))
    }
...
impl core::ops::Deref for B_CLOCK_INV_R {
    type Target = crate::FieldReader<bool, B_CLOCK_INV_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
pub struct CH_NR_R(crate::FieldReader<u8, CH_NR_A>);
impl CH_NR_R {
    pub(crate) fn new(bits: u8) -> Self {
        CH_NR_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
impl core::ops::Deref for CH_NR_R {
    type Target = crate::FieldReader<u8, CH_NR_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
pub struct I2S_MODE_R(crate::FieldReader<u8, I2S_MODE_A>);
impl I2S_MODE_R {
    pub(crate) fn new(bits: u8) -> Self {
        I2S_MODE_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
impl core::ops::Deref for I2S_MODE_R {
    type Target = crate::FieldReader<u8, I2S_MODE_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
pub struct WS_PULSE_R(crate::FieldReader<bool, WS_PULSE_A>);
impl WS_PULSE_R {
    pub(crate) fn new(bits: bool) -> Self {
        WS_PULSE_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
impl core::ops::Deref for WS_PULSE_R {
    type Target = crate::FieldReader<bool, WS_PULSE_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
pub struct WD_EN_R(crate::FieldReader<bool, bool>);
impl WD_EN_R {
    pub(crate) fn new(bits: bool) -> Self {
        WD_EN_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for WD_EN_R {
...
pub struct CH_LEN_R(crate::FieldReader<u8, CH_LEN_A>);
impl CH_LEN_R {
    pub(crate) fn new(bits: u8) -> Self {
        CH_LEN_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
impl core::ops::Deref for CH_LEN_R {
    type Target = crate::FieldReader<u8, CH_LEN_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
pub struct SCKO_POL_R(crate::FieldReader<bool, bool>);
impl SCKO_POL_R {
    pub(crate) fn new(bits: bool) -> Self {
        SCKO_POL_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SCKO_POL_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct SCKI_POL_R(crate::FieldReader<bool, bool>);
impl SCKI_POL_R {
    pub(crate) fn new(bits: bool) -> Self {
        SCKI_POL_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SCKI_POL_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
