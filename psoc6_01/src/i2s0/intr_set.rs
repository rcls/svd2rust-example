...
pub struct TX_TRIGGER_R(crate::FieldReader<bool, bool>);
impl TX_TRIGGER_R {
    pub(crate) fn new(bits: bool) -> Self {
        TX_TRIGGER_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for TX_TRIGGER_R {
...
pub struct TX_NOT_FULL_R(crate::FieldReader<bool, bool>);
impl TX_NOT_FULL_R {
    pub(crate) fn new(bits: bool) -> Self {
        TX_NOT_FULL_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for TX_NOT_FULL_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct TX_OVERFLOW_R(crate::FieldReader<bool, bool>);
impl TX_OVERFLOW_R {
    pub(crate) fn new(bits: bool) -> Self {
        TX_OVERFLOW_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for TX_OVERFLOW_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct TX_UNDERFLOW_R(crate::FieldReader<bool, bool>);
impl TX_UNDERFLOW_R {
    pub(crate) fn new(bits: bool) -> Self {
...
pub struct TX_WD_R(crate::FieldReader<bool, bool>);
impl TX_WD_R {
    pub(crate) fn new(bits: bool) -> Self {
        TX_WD_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for TX_WD_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct RX_WD_R(crate::FieldReader<bool, bool>);
impl RX_WD_R {
    pub(crate) fn new(bits: bool) -> Self {
        RX_WD_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for RX_WD_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
