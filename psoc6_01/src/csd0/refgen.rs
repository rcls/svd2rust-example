...
pub struct REFGEN_EN_R(crate::FieldReader<bool, REFGEN_EN_A>);
impl REFGEN_EN_R {
    pub(crate) fn new(bits: bool) -> Self {
        REFGEN_EN_R(crate::FieldReader::new(bits))
    }
...
impl core::ops::Deref for REFGEN_EN_R {
    type Target = crate::FieldReader<bool, REFGEN_EN_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
pub struct VDDA_EN_R(crate::FieldReader<bool, bool>);
impl VDDA_EN_R {
    pub(crate) fn new(bits: bool) -> Self {
        VDDA_EN_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for VDDA_EN_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct RES_EN_R(crate::FieldReader<bool, bool>);
impl RES_EN_R {
    pub(crate) fn new(bits: bool) -> Self {
        RES_EN_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for RES_EN_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct VREFLO_SEL_R(crate::FieldReader<u8, u8>);
impl VREFLO_SEL_R {
    pub(crate) fn new(bits: u8) -> Self {
        VREFLO_SEL_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for VREFLO_SEL_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct VREFLO_INT_R(crate::FieldReader<bool, bool>);
impl VREFLO_INT_R {
    pub(crate) fn new(bits: bool) -> Self {
        VREFLO_INT_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for VREFLO_INT_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
