...
pub struct CSDCMP_EN_R(crate::FieldReader<bool, CSDCMP_EN_A>);
impl CSDCMP_EN_R {
    pub(crate) fn new(bits: bool) -> Self {
        CSDCMP_EN_R(crate::FieldReader::new(bits))
    }
...
impl core::ops::Deref for CSDCMP_EN_R {
    type Target = crate::FieldReader<bool, CSDCMP_EN_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
pub struct POLARITY_SEL_R(crate::FieldReader<u8, POLARITY_SEL_A>);
impl POLARITY_SEL_R {
    pub(crate) fn new(bits: u8) -> Self {
        POLARITY_SEL_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
impl core::ops::Deref for POLARITY_SEL_R {
    type Target = crate::FieldReader<u8, POLARITY_SEL_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
pub struct CMP_PHASE_R(crate::FieldReader<u8, CMP_PHASE_A>);
impl CMP_PHASE_R {
    pub(crate) fn new(bits: u8) -> Self {
        CMP_PHASE_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
impl core::ops::Deref for CMP_PHASE_R {
    type Target = crate::FieldReader<u8, CMP_PHASE_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
pub struct CMP_MODE_R(crate::FieldReader<bool, CMP_MODE_A>);
impl CMP_MODE_R {
    pub(crate) fn new(bits: bool) -> Self {
        CMP_MODE_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
impl core::ops::Deref for CMP_MODE_R {
    type Target = crate::FieldReader<bool, CMP_MODE_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
pub struct FEEDBACK_MODE_R(crate::FieldReader<bool, FEEDBACK_MODE_A>);
impl FEEDBACK_MODE_R {
    pub(crate) fn new(bits: bool) -> Self {
        FEEDBACK_MODE_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
impl core::ops::Deref for FEEDBACK_MODE_R {
    type Target = crate::FieldReader<bool, FEEDBACK_MODE_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
