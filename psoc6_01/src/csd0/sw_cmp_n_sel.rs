...
pub struct SW_SCRH_R(crate::FieldReader<u8, u8>);
impl SW_SCRH_R {
    pub(crate) fn new(bits: u8) -> Self {
        SW_SCRH_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SW_SCRH_R {
...
pub struct SW_SCRL_R(crate::FieldReader<u8, u8>);
impl SW_SCRL_R {
    pub(crate) fn new(bits: u8) -> Self {
        SW_SCRL_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SW_SCRL_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
