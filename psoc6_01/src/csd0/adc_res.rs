...
pub struct VIN_CNT_R(crate::FieldReader<u16, u16>);
impl VIN_CNT_R {
    pub(crate) fn new(bits: u16) -> Self {
        VIN_CNT_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for VIN_CNT_R {
...
pub struct HSCMP_POL_R(crate::FieldReader<bool, bool>);
impl HSCMP_POL_R {
    pub(crate) fn new(bits: bool) -> Self {
        HSCMP_POL_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for HSCMP_POL_R {
...
pub struct ADC_ABORT_R(crate::FieldReader<bool, bool>);
impl ADC_ABORT_R {
    pub(crate) fn new(bits: bool) -> Self {
        ADC_ABORT_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for ADC_ABORT_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
