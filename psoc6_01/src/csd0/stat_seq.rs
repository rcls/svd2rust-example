...
pub struct SEQ_STATE_R(crate::FieldReader<u8, u8>);
impl SEQ_STATE_R {
    pub(crate) fn new(bits: u8) -> Self {
        SEQ_STATE_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SEQ_STATE_R {
...
pub struct ADC_STATE_R(crate::FieldReader<u8, u8>);
impl ADC_STATE_R {
    pub(crate) fn new(bits: u8) -> Self {
        ADC_STATE_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for ADC_STATE_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
