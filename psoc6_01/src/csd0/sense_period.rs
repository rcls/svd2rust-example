...
pub struct SENSE_DIV_R(crate::FieldReader<u16, u16>);
impl SENSE_DIV_R {
    pub(crate) fn new(bits: u16) -> Self {
        SENSE_DIV_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SENSE_DIV_R {
...
pub struct LFSR_SIZE_R(crate::FieldReader<u8, LFSR_SIZE_A>);
impl LFSR_SIZE_R {
    pub(crate) fn new(bits: u8) -> Self {
        LFSR_SIZE_R(crate::FieldReader::new(bits))
    }
...
impl core::ops::Deref for LFSR_SIZE_R {
    type Target = crate::FieldReader<u8, LFSR_SIZE_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
pub struct LFSR_SCALE_R(crate::FieldReader<u8, u8>);
impl LFSR_SCALE_R {
    pub(crate) fn new(bits: u8) -> Self {
        LFSR_SCALE_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for LFSR_SCALE_R {
...
pub struct LFSR_CLEAR_R(crate::FieldReader<bool, bool>);
impl LFSR_CLEAR_R {
    pub(crate) fn new(bits: bool) -> Self {
        LFSR_CLEAR_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for LFSR_CLEAR_R {
...
pub struct SEL_LFSR_MSB_R(crate::FieldReader<bool, bool>);
impl SEL_LFSR_MSB_R {
    pub(crate) fn new(bits: bool) -> Self {
        SEL_LFSR_MSB_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SEL_LFSR_MSB_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct LFSR_BITS_R(crate::FieldReader<u8, LFSR_BITS_A>);
impl LFSR_BITS_R {
    pub(crate) fn new(bits: u8) -> Self {
        LFSR_BITS_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
impl core::ops::Deref for LFSR_BITS_R {
    type Target = crate::FieldReader<u8, LFSR_BITS_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
