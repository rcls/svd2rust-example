...
pub struct OA0_SLOPE_OFFSET_TRIM_R(crate::FieldReader<u8, u8>);
impl OA0_SLOPE_OFFSET_TRIM_R {
    pub(crate) fn new(bits: u8) -> Self {
        OA0_SLOPE_OFFSET_TRIM_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for OA0_SLOPE_OFFSET_TRIM_R {
...
pub struct OA0_SLOPE_OFFSET_TRIM_W<'a> {
    w: &'a mut W,
}
impl<'a> OA0_SLOPE_OFFSET_TRIM_W<'a> {
...
impl W {
    #[doc = "Bits 0:5 - Opamp0 slope offset drift trim"]
    #[inline(always)]
    pub fn oa0_slope_offset_trim(&mut self) -> OA0_SLOPE_OFFSET_TRIM_W {
        OA0_SLOPE_OFFSET_TRIM_W { w: self }
    }
