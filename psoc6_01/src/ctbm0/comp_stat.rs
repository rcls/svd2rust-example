...
pub struct OA0_COMP_R(crate::FieldReader<bool, bool>);
impl OA0_COMP_R {
    pub(crate) fn new(bits: bool) -> Self {
        OA0_COMP_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for OA0_COMP_R {
...
pub struct OA1_COMP_R(crate::FieldReader<bool, bool>);
impl OA1_COMP_R {
    pub(crate) fn new(bits: bool) -> Self {
        OA1_COMP_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for OA1_COMP_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
