...
pub struct OA1_OFFSET_TRIM_R(crate::FieldReader<u8, u8>);
impl OA1_OFFSET_TRIM_R {
    pub(crate) fn new(bits: u8) -> Self {
        OA1_OFFSET_TRIM_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for OA1_OFFSET_TRIM_R {
