...
#[doc = "Field `OA0_COMP_TRIM` reader - Opamp0 Compensation Capacitor Trim. Value depends on the drive strength setting - 1x mode: set to 01; 10x mode: set to 11"]
pub struct OA0_COMP_TRIM_R(crate::FieldReader<u8, u8>);
impl OA0_COMP_TRIM_R {
    pub(crate) fn new(bits: u8) -> Self {
        OA0_COMP_TRIM_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for OA0_COMP_TRIM_R {
...
#[doc = "Field `OA0_COMP_TRIM` writer - Opamp0 Compensation Capacitor Trim. Value depends on the drive strength setting - 1x mode: set to 01; 10x mode: set to 11"]
