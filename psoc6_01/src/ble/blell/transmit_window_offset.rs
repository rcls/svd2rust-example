...
pub struct TX_WINDOW_OFFSET_R(crate::FieldReader<u16, u16>);
impl TX_WINDOW_OFFSET_R {
    pub(crate) fn new(bits: u16) -> Self {
        TX_WINDOW_OFFSET_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for TX_WINDOW_OFFSET_R {
