...
pub struct DATA_CHANNELS_LOWER_R(crate::FieldReader<u16, u16>);
impl DATA_CHANNELS_LOWER_R {
    pub(crate) fn new(bits: u16) -> Self {
        DATA_CHANNELS_LOWER_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for DATA_CHANNELS_LOWER_R {
