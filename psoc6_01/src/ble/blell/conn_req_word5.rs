...
pub struct CONNECTION_INTERVAL_VAL_R(crate::FieldReader<u16, u16>);
impl CONNECTION_INTERVAL_VAL_R {
    pub(crate) fn new(bits: u16) -> Self {
        CONNECTION_INTERVAL_VAL_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CONNECTION_INTERVAL_VAL_R {
