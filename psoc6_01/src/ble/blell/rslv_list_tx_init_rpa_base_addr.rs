...
pub struct RSLV_LIST_TX_INIT_RPA_BASE_ADDR_R(crate::FieldReader<u16, u16>);
impl RSLV_LIST_TX_INIT_RPA_BASE_ADDR_R {
    pub(crate) fn new(bits: u16) -> Self {
        RSLV_LIST_TX_INIT_RPA_BASE_ADDR_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for RSLV_LIST_TX_INIT_RPA_BASE_ADDR_R {
...
pub struct RSLV_LIST_TX_INIT_RPA_BASE_ADDR_W<'a> {
    w: &'a mut W,
}
impl<'a> RSLV_LIST_TX_INIT_RPA_BASE_ADDR_W<'a> {
...
impl W {
    #[doc = "Bits 0:15 - Device address values written to the list are written as 16-bit wide address."]
    #[inline(always)]
    pub fn rslv_list_tx_init_rpa_base_addr(&mut self) -> RSLV_LIST_TX_INIT_RPA_BASE_ADDR_W {
        RSLV_LIST_TX_INIT_RPA_BASE_ADDR_W { w: self }
    }
