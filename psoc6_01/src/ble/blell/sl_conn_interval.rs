...
pub struct SL_CONN_INTERVAL_VAL_R(crate::FieldReader<u16, u16>);
impl SL_CONN_INTERVAL_VAL_R {
    pub(crate) fn new(bits: u16) -> Self {
        SL_CONN_INTERVAL_VAL_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SL_CONN_INTERVAL_VAL_R {
