...
pub struct PEER_SEC_ADDR_H_R(crate::FieldReader<u16, u16>);
impl PEER_SEC_ADDR_H_R {
    pub(crate) fn new(bits: u16) -> Self {
        PEER_SEC_ADDR_H_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for PEER_SEC_ADDR_H_R {
