...
pub struct RECEIVE_PACKET_COUNT_R(crate::FieldReader<u8, u8>);
impl RECEIVE_PACKET_COUNT_R {
    pub(crate) fn new(bits: u8) -> Self {
        RECEIVE_PACKET_COUNT_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for RECEIVE_PACKET_COUNT_R {
