...
pub struct HOP_CH_TX_R(crate::FieldReader<u8, u8>);
impl HOP_CH_TX_R {
    pub(crate) fn new(bits: u8) -> Self {
        HOP_CH_TX_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for HOP_CH_TX_R {
...
pub struct HOP_CH_RX_R(crate::FieldReader<u8, u8>);
impl HOP_CH_RX_R {
    pub(crate) fn new(bits: u8) -> Self {
        HOP_CH_RX_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for HOP_CH_RX_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
