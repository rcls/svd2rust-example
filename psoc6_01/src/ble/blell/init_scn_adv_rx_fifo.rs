...
pub struct ADV_SCAN_RSP_RX_DATA_R(crate::FieldReader<u16, u16>);
impl ADV_SCAN_RSP_RX_DATA_R {
    pub(crate) fn new(bits: u16) -> Self {
        ADV_SCAN_RSP_RX_DATA_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for ADV_SCAN_RSP_RX_DATA_R {
