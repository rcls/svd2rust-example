...
pub struct DATA_CHANNELS_H1_R(crate::FieldReader<u8, u8>);
impl DATA_CHANNELS_H1_R {
    pub(crate) fn new(bits: u8) -> Self {
        DATA_CHANNELS_H1_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for DATA_CHANNELS_H1_R {
