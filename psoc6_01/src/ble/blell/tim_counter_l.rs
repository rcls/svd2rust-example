...
pub struct TIM_REF_CLOCK_R(crate::FieldReader<u16, u16>);
impl TIM_REF_CLOCK_R {
    pub(crate) fn new(bits: u16) -> Self {
        TIM_REF_CLOCK_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for TIM_REF_CLOCK_R {
