...
pub struct CONN_TX_MEM_BASE_ADDR_DLE_R(crate::FieldReader<u32, u32>);
impl CONN_TX_MEM_BASE_ADDR_DLE_R {
    pub(crate) fn new(bits: u32) -> Self {
        CONN_TX_MEM_BASE_ADDR_DLE_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CONN_TX_MEM_BASE_ADDR_DLE_R {
