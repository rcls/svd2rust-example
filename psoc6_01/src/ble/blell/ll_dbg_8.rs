...
pub struct ADV_RX_WR_PTR_STORE_R(crate::FieldReader<u8, u8>);
impl ADV_RX_WR_PTR_STORE_R {
    pub(crate) fn new(bits: u8) -> Self {
        ADV_RX_WR_PTR_STORE_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for ADV_RX_WR_PTR_STORE_R {
...
pub struct WLF_PTR_R(crate::FieldReader<u8, u8>);
impl WLF_PTR_R {
    pub(crate) fn new(bits: u8) -> Self {
        WLF_PTR_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for WLF_PTR_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
