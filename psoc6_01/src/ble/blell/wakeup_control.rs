...
pub struct WAKEUP_INSTANT_R(crate::FieldReader<u16, u16>);
impl WAKEUP_INSTANT_R {
    pub(crate) fn new(bits: u16) -> Self {
        WAKEUP_INSTANT_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for WAKEUP_INSTANT_R {
