...
pub struct CONN_RX_WR_PTR_STORE_R(crate::FieldReader<u16, u16>);
impl CONN_RX_WR_PTR_STORE_R {
    pub(crate) fn new(bits: u16) -> Self {
        CONN_RX_WR_PTR_STORE_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CONN_RX_WR_PTR_STORE_R {
