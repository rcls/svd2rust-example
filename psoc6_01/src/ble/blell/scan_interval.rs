...
pub struct SCAN_INTERVAL_R(crate::FieldReader<u16, u16>);
impl SCAN_INTERVAL_R {
    pub(crate) fn new(bits: u16) -> Self {
        SCAN_INTERVAL_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SCAN_INTERVAL_R {
