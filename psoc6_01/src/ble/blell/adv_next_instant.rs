...
pub struct ADV_NEXT_INSTANT_R(crate::FieldReader<u16, u16>);
impl ADV_NEXT_INSTANT_R {
    pub(crate) fn new(bits: u16) -> Self {
        ADV_NEXT_INSTANT_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for ADV_NEXT_INSTANT_R {
