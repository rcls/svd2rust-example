...
pub struct CONNECTION_FSM_STATE_R(crate::FieldReader<u8, u8>);
impl CONNECTION_FSM_STATE_R {
    pub(crate) fn new(bits: u8) -> Self {
        CONNECTION_FSM_STATE_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CONNECTION_FSM_STATE_R {
...
pub struct SLAVE_LATENCY_FSM_STATE_R(crate::FieldReader<u8, u8>);
impl SLAVE_LATENCY_FSM_STATE_R {
    pub(crate) fn new(bits: u8) -> Self {
        SLAVE_LATENCY_FSM_STATE_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SLAVE_LATENCY_FSM_STATE_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct ADVERTISER_FSM_STATE_R(crate::FieldReader<u8, u8>);
impl ADVERTISER_FSM_STATE_R {
    pub(crate) fn new(bits: u8) -> Self {
        ADVERTISER_FSM_STATE_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for ADVERTISER_FSM_STATE_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
