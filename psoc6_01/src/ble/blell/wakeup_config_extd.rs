...
pub struct DSM_LF_OFFSET_R(crate::FieldReader<u8, u8>);
impl DSM_LF_OFFSET_R {
    pub(crate) fn new(bits: u8) -> Self {
        DSM_LF_OFFSET_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for DSM_LF_OFFSET_R {
