...
pub struct INIT_INT_OFF_CAPT_R(crate::FieldReader<u16, u16>);
impl INIT_INT_OFF_CAPT_R {
    pub(crate) fn new(bits: u16) -> Self {
        INIT_INT_OFF_CAPT_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for INIT_INT_OFF_CAPT_R {
