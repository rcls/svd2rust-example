...
pub struct ADV_ACCADDR_H_R(crate::FieldReader<u16, u16>);
impl ADV_ACCADDR_H_R {
    pub(crate) fn new(bits: u16) -> Self {
        ADV_ACCADDR_H_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for ADV_ACCADDR_H_R {
