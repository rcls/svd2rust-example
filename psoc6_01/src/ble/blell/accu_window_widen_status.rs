...
pub struct ACCU_WINDOW_WIDEN_R(crate::FieldReader<u16, u16>);
impl ACCU_WINDOW_WIDEN_R {
    pub(crate) fn new(bits: u16) -> Self {
        ACCU_WINDOW_WIDEN_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for ACCU_WINDOW_WIDEN_R {
