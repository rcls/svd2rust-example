...
pub struct SUPERVISION_TIMEOUT_VAL_R(crate::FieldReader<u16, u16>);
impl SUPERVISION_TIMEOUT_VAL_R {
    pub(crate) fn new(bits: u16) -> Self {
        SUPERVISION_TIMEOUT_VAL_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SUPERVISION_TIMEOUT_VAL_R {
...
pub struct SUPERVISION_TIMEOUT_VAL_W<'a> {
    w: &'a mut W,
}
impl<'a> SUPERVISION_TIMEOUT_VAL_W<'a> {
...
impl W {
    #[doc = "Bits 0:15 - This field defines the maximum time between two received Data packet PDUs before the connection is considered lost. This shall be a multiple of 10 ms in the range of 100 ms to 32.0 s and it shall be larger than (1+connSlaveLatency)*connInterval."]
    #[inline(always)]
    pub fn supervision_timeout_val(&mut self) -> SUPERVISION_TIMEOUT_VAL_W {
        SUPERVISION_TIMEOUT_VAL_W { w: self }
    }
