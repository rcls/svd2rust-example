...
pub struct DEV_PUB_ADDR_L_R(crate::FieldReader<u16, u16>);
impl DEV_PUB_ADDR_L_R {
    pub(crate) fn new(bits: u16) -> Self {
        DEV_PUB_ADDR_L_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for DEV_PUB_ADDR_L_R {
