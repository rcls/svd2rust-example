...
pub struct CONN_PING_TIMER_NEXT_EXP_R(crate::FieldReader<u16, u16>);
impl CONN_PING_TIMER_NEXT_EXP_R {
    pub(crate) fn new(bits: u16) -> Self {
        CONN_PING_TIMER_NEXT_EXP_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CONN_PING_TIMER_NEXT_EXP_R {
