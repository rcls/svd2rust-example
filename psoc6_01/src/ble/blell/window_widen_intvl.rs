...
pub struct WINDOW_WIDEN_INTVL_R(crate::FieldReader<u16, u16>);
impl WINDOW_WIDEN_INTVL_R {
    pub(crate) fn new(bits: u16) -> Self {
        WINDOW_WIDEN_INTVL_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for WINDOW_WIDEN_INTVL_R {
