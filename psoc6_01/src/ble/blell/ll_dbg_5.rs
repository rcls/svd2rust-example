...
pub struct INIT_FSM_STATE_R(crate::FieldReader<u8, u8>);
impl INIT_FSM_STATE_R {
    pub(crate) fn new(bits: u8) -> Self {
        INIT_FSM_STATE_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for INIT_FSM_STATE_R {
...
pub struct SCAN_FSM_STATE_R(crate::FieldReader<u8, u8>);
impl SCAN_FSM_STATE_R {
    pub(crate) fn new(bits: u8) -> Self {
        SCAN_FSM_STATE_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SCAN_FSM_STATE_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
