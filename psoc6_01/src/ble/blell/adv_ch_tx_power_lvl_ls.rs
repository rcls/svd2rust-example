...
pub struct ADV_TRANSMIT_POWER_LVL_LS_R(crate::FieldReader<u16, u16>);
impl ADV_TRANSMIT_POWER_LVL_LS_R {
    pub(crate) fn new(bits: u16) -> Self {
        ADV_TRANSMIT_POWER_LVL_LS_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for ADV_TRANSMIT_POWER_LVL_LS_R {
