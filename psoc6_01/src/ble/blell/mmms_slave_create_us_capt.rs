...
pub struct US_OFFSET_SLAVE_CREATED_R(crate::FieldReader<u16, u16>);
impl US_OFFSET_SLAVE_CREATED_R {
    pub(crate) fn new(bits: u16) -> Self {
        US_OFFSET_SLAVE_CREATED_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for US_OFFSET_SLAVE_CREATED_R {
