...
pub struct RX_PACKET_COUNT_R(crate::FieldReader<u16, u16>);
impl RX_PACKET_COUNT_R {
    pub(crate) fn new(bits: u16) -> Self {
        RX_PACKET_COUNT_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for RX_PACKET_COUNT_R {
