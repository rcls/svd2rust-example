...
pub struct ADV_TX_WR_PTR_R(crate::FieldReader<u8, u8>);
impl ADV_TX_WR_PTR_R {
    pub(crate) fn new(bits: u8) -> Self {
        ADV_TX_WR_PTR_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for ADV_TX_WR_PTR_R {
...
pub struct SCAN_RSP_TX_WR_PTR_R(crate::FieldReader<u8, u8>);
impl SCAN_RSP_TX_WR_PTR_R {
    pub(crate) fn new(bits: u8) -> Self {
        SCAN_RSP_TX_WR_PTR_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SCAN_RSP_TX_WR_PTR_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct ADV_TX_RD_PTR_R(crate::FieldReader<u8, u8>);
impl ADV_TX_RD_PTR_R {
    pub(crate) fn new(bits: u8) -> Self {
        ADV_TX_RD_PTR_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for ADV_TX_RD_PTR_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
