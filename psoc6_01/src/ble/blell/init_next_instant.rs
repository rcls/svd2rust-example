...
pub struct INIT_NEXT_INSTANT_R(crate::FieldReader<u16, u16>);
impl INIT_NEXT_INSTANT_R {
    pub(crate) fn new(bits: u16) -> Self {
        INIT_NEXT_INSTANT_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for INIT_NEXT_INSTANT_R {
