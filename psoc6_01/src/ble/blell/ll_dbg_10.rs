...
pub struct RF_CHANNEL_NUM_R(crate::FieldReader<u8, u8>);
impl RF_CHANNEL_NUM_R {
    pub(crate) fn new(bits: u8) -> Self {
        RF_CHANNEL_NUM_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for RF_CHANNEL_NUM_R {
