...
pub struct PDU_ACCESS_ADDRESS_HIGHER_BITS_R(crate::FieldReader<u16, u16>);
impl PDU_ACCESS_ADDRESS_HIGHER_BITS_R {
    pub(crate) fn new(bits: u16) -> Self {
        PDU_ACCESS_ADDRESS_HIGHER_BITS_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for PDU_ACCESS_ADDRESS_HIGHER_BITS_R {
