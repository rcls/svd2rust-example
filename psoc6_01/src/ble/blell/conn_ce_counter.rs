...
pub struct CONNECTION_EVENT_COUNTER_R(crate::FieldReader<u16, u16>);
impl CONNECTION_EVENT_COUNTER_R {
    pub(crate) fn new(bits: u16) -> Self {
        CONNECTION_EVENT_COUNTER_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CONNECTION_EVENT_COUNTER_R {
