...
pub struct NEXT_CE_INSTANT_R(crate::FieldReader<u16, u16>);
impl NEXT_CE_INSTANT_R {
    pub(crate) fn new(bits: u16) -> Self {
        NEXT_CE_INSTANT_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for NEXT_CE_INSTANT_R {
