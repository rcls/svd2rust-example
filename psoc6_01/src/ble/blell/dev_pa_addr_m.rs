...
pub struct DEV_PA_ADDR_M_R(crate::FieldReader<u16, u16>);
impl DEV_PA_ADDR_M_R {
    pub(crate) fn new(bits: u16) -> Self {
        DEV_PA_ADDR_M_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for DEV_PA_ADDR_M_R {
