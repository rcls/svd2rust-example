...
pub struct INIT_WINDOW_NI_R(crate::FieldReader<u16, u16>);
impl INIT_WINDOW_NI_R {
    pub(crate) fn new(bits: u16) -> Self {
        INIT_WINDOW_NI_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for INIT_WINDOW_NI_R {
