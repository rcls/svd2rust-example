...
pub struct EARLY_INTR_NI_R(crate::FieldReader<u16, u16>);
impl EARLY_INTR_NI_R {
    pub(crate) fn new(bits: u16) -> Self {
        EARLY_INTR_NI_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for EARLY_INTR_NI_R {
