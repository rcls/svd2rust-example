...
pub struct CONN_SEC_CURRENT_WRAP_R(crate::FieldReader<u16, u16>);
impl CONN_SEC_CURRENT_WRAP_R {
    pub(crate) fn new(bits: u16) -> Self {
        CONN_SEC_CURRENT_WRAP_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CONN_SEC_CURRENT_WRAP_R {
