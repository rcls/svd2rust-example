...
pub struct INIT_SCAN_WINDOW_R(crate::FieldReader<u16, u16>);
impl INIT_SCAN_WINDOW_R {
    pub(crate) fn new(bits: u16) -> Self {
        INIT_SCAN_WINDOW_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for INIT_SCAN_WINDOW_R {
