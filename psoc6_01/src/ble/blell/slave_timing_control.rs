...
pub struct SLAVE_TIME_SET_VAL_R(crate::FieldReader<u8, u8>);
impl SLAVE_TIME_SET_VAL_R {
    pub(crate) fn new(bits: u8) -> Self {
        SLAVE_TIME_SET_VAL_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SLAVE_TIME_SET_VAL_R {
...
pub struct SLAVE_TIME_ADJ_VAL_R(crate::FieldReader<u8, u8>);
impl SLAVE_TIME_ADJ_VAL_R {
    pub(crate) fn new(bits: u8) -> Self {
        SLAVE_TIME_ADJ_VAL_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SLAVE_TIME_ADJ_VAL_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
