...
pub struct SLAVE_LATENCY_VAL_R(crate::FieldReader<u16, u16>);
impl SLAVE_LATENCY_VAL_R {
    pub(crate) fn new(bits: u16) -> Self {
        SLAVE_LATENCY_VAL_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SLAVE_LATENCY_VAL_R {
