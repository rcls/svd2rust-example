...
pub struct DEV_PUB_ADDR_H_R(crate::FieldReader<u16, u16>);
impl DEV_PUB_ADDR_H_R {
    pub(crate) fn new(bits: u16) -> Self {
        DEV_PUB_ADDR_H_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for DEV_PUB_ADDR_H_R {
...
pub struct DEV_PUB_ADDR_H_W<'a> {
    w: &'a mut W,
}
impl<'a> DEV_PUB_ADDR_H_W<'a> {
...
impl W {
    #[doc = "Bits 0:15 - Higher 16 bit of 48-bit public address of the device."]
    #[inline(always)]
    pub fn dev_pub_addr_h(&mut self) -> DEV_PUB_ADDR_H_W {
        DEV_PUB_ADDR_H_W { w: self }
    }
