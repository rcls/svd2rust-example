...
pub struct CONN_INDEX_FOR_EARLY_INTR_R(crate::FieldReader<u8, u8>);
impl CONN_INDEX_FOR_EARLY_INTR_R {
    pub(crate) fn new(bits: u8) -> Self {
        CONN_INDEX_FOR_EARLY_INTR_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CONN_INDEX_FOR_EARLY_INTR_R {
...
pub struct CONN_TYPE_FOR_EARLY_INTR_R(crate::FieldReader<bool, bool>);
impl CONN_TYPE_FOR_EARLY_INTR_R {
    pub(crate) fn new(bits: bool) -> Self {
        CONN_TYPE_FOR_EARLY_INTR_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CONN_TYPE_FOR_EARLY_INTR_R {
...
pub struct US_FOR_EARLY_INTR_R(crate::FieldReader<u16, u16>);
impl US_FOR_EARLY_INTR_R {
    pub(crate) fn new(bits: u16) -> Self {
        US_FOR_EARLY_INTR_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for US_FOR_EARLY_INTR_R {
