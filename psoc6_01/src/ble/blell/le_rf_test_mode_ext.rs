...
pub struct DTM_PACKET_LENGTH_R(crate::FieldReader<u8, u8>);
impl DTM_PACKET_LENGTH_R {
    pub(crate) fn new(bits: u8) -> Self {
        DTM_PACKET_LENGTH_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for DTM_PACKET_LENGTH_R {
