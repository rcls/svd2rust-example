...
pub struct DEVICE_RAND_ADDR_M_R(crate::FieldReader<u16, u16>);
impl DEVICE_RAND_ADDR_M_R {
    pub(crate) fn new(bits: u16) -> Self {
        DEVICE_RAND_ADDR_M_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for DEVICE_RAND_ADDR_M_R {
