...
pub struct MMMS_RX_PKT_CNT_R(crate::FieldReader<u8, u8>);
impl MMMS_RX_PKT_CNT_R {
    pub(crate) fn new(bits: u8) -> Self {
        MMMS_RX_PKT_CNT_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for MMMS_RX_PKT_CNT_R {
