...
pub struct WL_ENTRY_CONNECTED_R(crate::FieldReader<u16, u16>);
impl WL_ENTRY_CONNECTED_R {
    pub(crate) fn new(bits: u16) -> Self {
        WL_ENTRY_CONNECTED_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for WL_ENTRY_CONNECTED_R {
