...
pub struct CONN_UPDT_INTERVAL_R(crate::FieldReader<u16, u16>);
impl CONN_UPDT_INTERVAL_R {
    pub(crate) fn new(bits: u16) -> Self {
        CONN_UPDT_INTERVAL_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CONN_UPDT_INTERVAL_R {
