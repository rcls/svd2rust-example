...
pub struct RSSI_R(crate::FieldReader<u16, u16>);
impl RSSI_R {
    pub(crate) fn new(bits: u16) -> Self {
        RSSI_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for RSSI_R {
...
pub struct RX_CHANNEL_R(crate::FieldReader<u8, u8>);
impl RX_CHANNEL_R {
    pub(crate) fn new(bits: u8) -> Self {
        RX_CHANNEL_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for RX_CHANNEL_R {
...
pub struct PKT_RSSI_OR_CH_ENERGY_R(crate::FieldReader<bool, bool>);
impl PKT_RSSI_OR_CH_ENERGY_R {
    pub(crate) fn new(bits: bool) -> Self {
        PKT_RSSI_OR_CH_ENERGY_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for PKT_RSSI_OR_CH_ENERGY_R {
