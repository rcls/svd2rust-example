...
pub struct PWR_CTRL_SM_CURR_STATE_R(crate::FieldReader<u8, u8>);
impl PWR_CTRL_SM_CURR_STATE_R {
    pub(crate) fn new(bits: u8) -> Self {
        PWR_CTRL_SM_CURR_STATE_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for PWR_CTRL_SM_CURR_STATE_R {
