...
pub struct BLESS_STATE_R(crate::FieldReader<bool, bool>);
impl BLESS_STATE_R {
    pub(crate) fn new(bits: bool) -> Self {
        BLESS_STATE_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for BLESS_STATE_R {
...
pub struct MT_CURR_STATE_R(crate::FieldReader<u8, u8>);
impl MT_CURR_STATE_R {
    pub(crate) fn new(bits: u8) -> Self {
        MT_CURR_STATE_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for MT_CURR_STATE_R {
...
pub struct HVLDO_STARTUP_CURR_STATE_R(crate::FieldReader<u8, u8>);
impl HVLDO_STARTUP_CURR_STATE_R {
    pub(crate) fn new(bits: u8) -> Self {
        HVLDO_STARTUP_CURR_STATE_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for HVLDO_STARTUP_CURR_STATE_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct LL_CLK_STATE_R(crate::FieldReader<bool, bool>);
impl LL_CLK_STATE_R {
    pub(crate) fn new(bits: bool) -> Self {
        LL_CLK_STATE_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for LL_CLK_STATE_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
