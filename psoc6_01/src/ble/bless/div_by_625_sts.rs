...
pub struct QUOTIENT_R(crate::FieldReader<u8, u8>);
impl QUOTIENT_R {
...
pub struct REMAINDER_R(crate::FieldReader<u16, u16>);
impl REMAINDER_R {
    pub(crate) fn new(bits: u16) -> Self {
        REMAINDER_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for REMAINDER_R {
