...
pub struct TX_TRIGGER_LEVEL_R(crate::FieldReader<u8, u8>);
impl TX_TRIGGER_LEVEL_R {
    pub(crate) fn new(bits: u8) -> Self {
        TX_TRIGGER_LEVEL_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for TX_TRIGGER_LEVEL_R {
