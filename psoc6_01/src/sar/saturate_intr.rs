...
pub struct SATURATE_INTR_R(crate::FieldReader<u16, u16>);
impl SATURATE_INTR_R {
    pub(crate) fn new(bits: u16) -> Self {
        SATURATE_INTR_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SATURATE_INTR_R {
