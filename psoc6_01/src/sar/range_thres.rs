...
pub struct RANGE_LOW_R(crate::FieldReader<u16, u16>);
impl RANGE_LOW_R {
    pub(crate) fn new(bits: u16) -> Self {
        RANGE_LOW_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for RANGE_LOW_R {
...
pub struct RANGE_HIGH_R(crate::FieldReader<u16, u16>);
impl RANGE_HIGH_R {
    pub(crate) fn new(bits: u16) -> Self {
        RANGE_HIGH_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for RANGE_HIGH_R {
    type Target = crate::FieldReader<u16, u16>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
