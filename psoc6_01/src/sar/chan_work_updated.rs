...
pub struct CHAN_WORK_UPDATED_R(crate::FieldReader<u16, u16>);
impl CHAN_WORK_UPDATED_R {
    pub(crate) fn new(bits: u16) -> Self {
        CHAN_WORK_UPDATED_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CHAN_WORK_UPDATED_R {
