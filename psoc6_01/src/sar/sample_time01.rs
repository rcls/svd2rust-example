...
pub struct SAMPLE_TIME0_R(crate::FieldReader<u16, u16>);
impl SAMPLE_TIME0_R {
    pub(crate) fn new(bits: u16) -> Self {
        SAMPLE_TIME0_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SAMPLE_TIME0_R {
...
pub struct SAMPLE_TIME1_R(crate::FieldReader<u16, u16>);
impl SAMPLE_TIME1_R {
    pub(crate) fn new(bits: u16) -> Self {
        SAMPLE_TIME1_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SAMPLE_TIME1_R {
    type Target = crate::FieldReader<u16, u16>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
