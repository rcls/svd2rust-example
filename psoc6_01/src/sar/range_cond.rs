...
pub struct RANGE_COND_R(crate::FieldReader<u8, RANGE_COND_A>);
impl RANGE_COND_R {
    pub(crate) fn new(bits: u8) -> Self {
        RANGE_COND_R(crate::FieldReader::new(bits))
    }
...
impl core::ops::Deref for RANGE_COND_R {
    type Target = crate::FieldReader<u8, RANGE_COND_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
