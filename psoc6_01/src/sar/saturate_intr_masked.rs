...
pub struct SATURATE_MASKED_R(crate::FieldReader<u16, u16>);
impl SATURATE_MASKED_R {
    pub(crate) fn new(bits: u16) -> Self {
        SATURATE_MASKED_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SATURATE_MASKED_R {
