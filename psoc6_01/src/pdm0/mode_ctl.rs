...
pub struct PCM_CH_SET_R(crate::FieldReader<u8, PCM_CH_SET_A>);
impl PCM_CH_SET_R {
    pub(crate) fn new(bits: u8) -> Self {
        PCM_CH_SET_R(crate::FieldReader::new(bits))
    }
...
impl core::ops::Deref for PCM_CH_SET_R {
    type Target = crate::FieldReader<u8, PCM_CH_SET_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
pub struct SWAP_LR_R(crate::FieldReader<bool, bool>);
impl SWAP_LR_R {
    pub(crate) fn new(bits: bool) -> Self {
        SWAP_LR_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SWAP_LR_R {
...
pub struct S_CYCLES_R(crate::FieldReader<u8, S_CYCLES_A>);
impl S_CYCLES_R {
    pub(crate) fn new(bits: u8) -> Self {
...
impl core::ops::Deref for S_CYCLES_R {
    type Target = crate::FieldReader<u8, S_CYCLES_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
pub struct CKO_DELAY_R(crate::FieldReader<u8, CKO_DELAY_A>);
impl CKO_DELAY_R {
    pub(crate) fn new(bits: u8) -> Self {
        CKO_DELAY_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
impl core::ops::Deref for CKO_DELAY_R {
    type Target = crate::FieldReader<u8, CKO_DELAY_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
pub struct HPF_GAIN_R(crate::FieldReader<u8, u8>);
impl HPF_GAIN_R {
    pub(crate) fn new(bits: u8) -> Self {
        HPF_GAIN_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for HPF_GAIN_R {
...
pub struct HPF_EN_N_R(crate::FieldReader<bool, bool>);
impl HPF_EN_N_R {
    pub(crate) fn new(bits: bool) -> Self {
        HPF_EN_N_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for HPF_EN_N_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
