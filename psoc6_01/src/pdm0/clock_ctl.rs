...
pub struct CLK_CLOCK_DIV_R(crate::FieldReader<u8, CLK_CLOCK_DIV_A>);
impl CLK_CLOCK_DIV_R {
    pub(crate) fn new(bits: u8) -> Self {
        CLK_CLOCK_DIV_R(crate::FieldReader::new(bits))
    }
...
impl core::ops::Deref for CLK_CLOCK_DIV_R {
    type Target = crate::FieldReader<u8, CLK_CLOCK_DIV_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
pub struct MCLKQ_CLOCK_DIV_R(crate::FieldReader<u8, MCLKQ_CLOCK_DIV_A>);
impl MCLKQ_CLOCK_DIV_R {
    pub(crate) fn new(bits: u8) -> Self {
        MCLKQ_CLOCK_DIV_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
impl core::ops::Deref for MCLKQ_CLOCK_DIV_R {
    type Target = crate::FieldReader<u8, MCLKQ_CLOCK_DIV_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
pub struct CKO_CLOCK_DIV_R(crate::FieldReader<u8, u8>);
impl CKO_CLOCK_DIV_R {
    pub(crate) fn new(bits: u8) -> Self {
        CKO_CLOCK_DIV_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CKO_CLOCK_DIV_R {
