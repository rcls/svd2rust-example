...
pub struct EP1DRQED_R(crate::FieldReader<bool, bool>);
impl EP1DRQED_R {
    pub(crate) fn new(bits: bool) -> Self {
        EP1DRQED_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for EP1DRQED_R {
...
pub struct EP1SPKED_R(crate::FieldReader<bool, bool>);
impl EP1SPKED_R {
    pub(crate) fn new(bits: bool) -> Self {
        EP1SPKED_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for EP1SPKED_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct EP2DRQED_R(crate::FieldReader<bool, bool>);
impl EP2DRQED_R {
    pub(crate) fn new(bits: bool) -> Self {
        EP2DRQED_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for EP2DRQED_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct EP2SPKED_R(crate::FieldReader<bool, bool>);
impl EP2SPKED_R {
    pub(crate) fn new(bits: bool) -> Self {
        EP2SPKED_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for EP2SPKED_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
