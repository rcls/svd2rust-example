...
#[doc = "Field `BFDT16` reader - Data Register for EP2 for 2 byte data."]
...
#[doc = "Field `BFDT16` writer - Data Register for EP2 for 2 byte data."]
...
impl R {
    #[doc = "Bits 0:15 - Data Register for EP2 for 2 byte data."]
    #[inline(always)]
