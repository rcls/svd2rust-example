#[doc = "Register `INTR_USBHOST_CAUSE_HI` reader"]
pub struct R(crate::R<INTR_USBHOST_CAUSE_HI_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<INTR_USBHOST_CAUSE_HI_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<INTR_USBHOST_CAUSE_HI_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<INTR_USBHOST_CAUSE_HI_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Interrupt USB Host Cause High Register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [intr_usbhost_cause_hi](index.html) module"]
pub struct INTR_USBHOST_CAUSE_HI_SPEC;
impl crate::RegisterSpec for INTR_USBHOST_CAUSE_HI_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [intr_usbhost_cause_hi::R](R) reader structure"]
impl crate::Readable for INTR_USBHOST_CAUSE_HI_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets INTR_USBHOST_CAUSE_HI to value 0"]
impl crate::Resettable for INTR_USBHOST_CAUSE_HI_SPEC {
    #[inline(always)]
