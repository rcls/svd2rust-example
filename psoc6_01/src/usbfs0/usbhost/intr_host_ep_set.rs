...
pub struct EP1DRQS_R(crate::FieldReader<bool, bool>);
impl EP1DRQS_R {
    pub(crate) fn new(bits: bool) -> Self {
        EP1DRQS_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for EP1DRQS_R {
...
pub struct EP1SPKS_R(crate::FieldReader<bool, bool>);
impl EP1SPKS_R {
    pub(crate) fn new(bits: bool) -> Self {
        EP1SPKS_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for EP1SPKS_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct EP2DRQS_R(crate::FieldReader<bool, bool>);
impl EP2DRQS_R {
    pub(crate) fn new(bits: bool) -> Self {
        EP2DRQS_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for EP2DRQS_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct EP2SPKS_R(crate::FieldReader<bool, bool>);
impl EP2SPKS_R {
    pub(crate) fn new(bits: bool) -> Self {
        EP2SPKS_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for EP2SPKS_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
