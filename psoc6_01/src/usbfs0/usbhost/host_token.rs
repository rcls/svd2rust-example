...
pub struct TKNEN_R(crate::FieldReader<u8, TKNEN_A>);
impl TKNEN_R {
    pub(crate) fn new(bits: u8) -> Self {
        TKNEN_R(crate::FieldReader::new(bits))
    }
...
impl core::ops::Deref for TKNEN_R {
    type Target = crate::FieldReader<u8, TKNEN_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
pub struct TGGL_R(crate::FieldReader<bool, bool>);
impl TGGL_R {
    pub(crate) fn new(bits: bool) -> Self {
        TGGL_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for TGGL_R {
