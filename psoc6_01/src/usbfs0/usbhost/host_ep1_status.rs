...
pub struct SIZE1_R(crate::FieldReader<u16, u16>);
impl SIZE1_R {
    pub(crate) fn new(bits: u16) -> Self {
        SIZE1_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SIZE1_R {
...
pub struct VAL_DATA_R(crate::FieldReader<bool, bool>);
impl VAL_DATA_R {
    pub(crate) fn new(bits: bool) -> Self {
        VAL_DATA_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for VAL_DATA_R {
...
pub struct INI_ST_R(crate::FieldReader<bool, bool>);
impl INI_ST_R {
    pub(crate) fn new(bits: bool) -> Self {
        INI_ST_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for INI_ST_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
