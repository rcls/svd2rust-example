...
pub struct TMODE_R(crate::FieldReader<bool, bool>);
impl TMODE_R {
    pub(crate) fn new(bits: bool) -> Self {
...
pub struct SOFBUSY_R(crate::FieldReader<bool, bool>);
impl SOFBUSY_R {
    pub(crate) fn new(bits: bool) -> Self {
        SOFBUSY_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SOFBUSY_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct RSTBUSY_R(crate::FieldReader<bool, bool>);
impl RSTBUSY_R {
    pub(crate) fn new(bits: bool) -> Self {
        RSTBUSY_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for RSTBUSY_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct CLKSEL_ST_R(crate::FieldReader<bool, bool>);
impl CLKSEL_ST_R {
    pub(crate) fn new(bits: bool) -> Self {
        CLKSEL_ST_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CLKSEL_ST_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct HOST_ST_R(crate::FieldReader<bool, bool>);
impl HOST_ST_R {
    pub(crate) fn new(bits: bool) -> Self {
        HOST_ST_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for HOST_ST_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
