...
pub struct R(crate::R<ARB_RW3_RA_MSB_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<ARB_RW3_RA_MSB_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<ARB_RW3_RA_MSB_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<ARB_RW3_RA_MSB_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `ARB_RW3_RA_MSB` writer"]
pub struct W(crate::W<ARB_RW3_RA_MSB_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<ARB_RW3_RA_MSB_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<ARB_RW3_RA_MSB_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<ARB_RW3_RA_MSB_SPEC>) -> Self {
        W(writer)
    }
}
