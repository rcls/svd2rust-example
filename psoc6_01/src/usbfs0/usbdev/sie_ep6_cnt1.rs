#[doc = "Register `SIE_EP6_CNT1` reader"]
pub struct R(crate::R<SIE_EP6_CNT1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SIE_EP6_CNT1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SIE_EP6_CNT1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SIE_EP6_CNT1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SIE_EP6_CNT1` writer"]
pub struct W(crate::W<SIE_EP6_CNT1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SIE_EP6_CNT1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SIE_EP6_CNT1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SIE_EP6_CNT1_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Non-control endpoint count register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [sie_ep6_cnt1](index.html) module"]
pub struct SIE_EP6_CNT1_SPEC;
impl crate::RegisterSpec for SIE_EP6_CNT1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [sie_ep6_cnt1::R](R) reader structure"]
impl crate::Readable for SIE_EP6_CNT1_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [sie_ep6_cnt1::W](W) writer structure"]
impl crate::Writable for SIE_EP6_CNT1_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets SIE_EP6_CNT1 to value 0"]
impl crate::Resettable for SIE_EP6_CNT1_SPEC {
    #[inline(always)]
