...
pub struct FRAME_NUMBER_MSB_R(crate::FieldReader<u8, u8>);
impl FRAME_NUMBER_MSB_R {
    pub(crate) fn new(bits: u8) -> Self {
        FRAME_NUMBER_MSB_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for FRAME_NUMBER_MSB_R {
