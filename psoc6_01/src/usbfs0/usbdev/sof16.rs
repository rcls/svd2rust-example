...
pub struct FRAME_NUMBER16_R(crate::FieldReader<u16, u16>);
impl FRAME_NUMBER16_R {
    pub(crate) fn new(bits: u16) -> Self {
        FRAME_NUMBER16_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for FRAME_NUMBER16_R {
