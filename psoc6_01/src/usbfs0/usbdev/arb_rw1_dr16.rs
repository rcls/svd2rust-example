...
pub struct R(crate::R<ARB_RW1_DR16_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<ARB_RW1_DR16_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<ARB_RW1_DR16_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<ARB_RW1_DR16_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `ARB_RW1_DR16` writer"]
pub struct W(crate::W<ARB_RW1_DR16_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<ARB_RW1_DR16_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<ARB_RW1_DR16_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<ARB_RW1_DR16_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Endpoint Data Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [arb_rw1_dr16](index.html) module"]
pub struct ARB_RW1_DR16_SPEC;
impl crate::RegisterSpec for ARB_RW1_DR16_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [arb_rw1_dr16::R](R) reader structure"]
impl crate::Readable for ARB_RW1_DR16_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [arb_rw1_dr16::W](W) writer structure"]
impl crate::Writable for ARB_RW1_DR16_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets ARB_RW1_DR16 to value 0"]
impl crate::Resettable for ARB_RW1_DR16_SPEC {
    #[inline(always)]
