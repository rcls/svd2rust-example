#[doc = "Register `ARB_EP3_SR` reader"]
pub struct R(crate::R<ARB_EP3_SR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<ARB_EP3_SR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<ARB_EP3_SR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<ARB_EP3_SR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `ARB_EP3_SR` writer"]
pub struct W(crate::W<ARB_EP3_SR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<ARB_EP3_SR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<ARB_EP3_SR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<ARB_EP3_SR_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Endpoint Interrupt Enable Register *1\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [arb_ep3_sr](index.html) module"]
pub struct ARB_EP3_SR_SPEC;
impl crate::RegisterSpec for ARB_EP3_SR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [arb_ep3_sr::R](R) reader structure"]
impl crate::Readable for ARB_EP3_SR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [arb_ep3_sr::W](W) writer structure"]
impl crate::Writable for ARB_EP3_SR_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets ARB_EP3_SR to value 0"]
impl crate::Resettable for ARB_EP3_SR_SPEC {
    #[inline(always)]
