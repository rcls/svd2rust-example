...
pub struct R(crate::R<SIE_EP3_CNT1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SIE_EP3_CNT1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SIE_EP3_CNT1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SIE_EP3_CNT1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SIE_EP3_CNT1` writer"]
pub struct W(crate::W<SIE_EP3_CNT1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SIE_EP3_CNT1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SIE_EP3_CNT1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SIE_EP3_CNT1_SPEC>) -> Self {
        W(writer)
    }
}
