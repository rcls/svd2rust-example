...
pub struct DM_P_R(crate::FieldReader<u8, DM_P_A>);
impl DM_P_R {
    pub(crate) fn new(bits: u8) -> Self {
        DM_P_R(crate::FieldReader::new(bits))
    }
...
impl core::ops::Deref for DM_P_R {
    type Target = crate::FieldReader<u8, DM_P_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
pub struct DM_M_R(crate::FieldReader<u8, u8>);
impl DM_M_R {
    pub(crate) fn new(bits: u8) -> Self {
        DM_M_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for DM_M_R {
