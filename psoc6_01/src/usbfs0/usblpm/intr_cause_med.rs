#[doc = "Register `INTR_CAUSE_MED` reader"]
pub struct R(crate::R<INTR_CAUSE_MED_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<INTR_CAUSE_MED_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<INTR_CAUSE_MED_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<INTR_CAUSE_MED_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Medium priority interrupt Cause register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [intr_cause_med](index.html) module"]
pub struct INTR_CAUSE_MED_SPEC;
impl crate::RegisterSpec for INTR_CAUSE_MED_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [intr_cause_med::R](R) reader structure"]
impl crate::Readable for INTR_CAUSE_MED_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets INTR_CAUSE_MED to value 0"]
impl crate::Resettable for INTR_CAUSE_MED_SPEC {
    #[inline(always)]
