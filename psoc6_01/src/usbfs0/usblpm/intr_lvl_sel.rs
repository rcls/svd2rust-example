...
pub struct SOF_LVL_SEL_R(crate::FieldReader<u8, SOF_LVL_SEL_A>);
impl SOF_LVL_SEL_R {
    pub(crate) fn new(bits: u8) -> Self {
        SOF_LVL_SEL_R(crate::FieldReader::new(bits))
    }
...
impl core::ops::Deref for SOF_LVL_SEL_R {
    type Target = crate::FieldReader<u8, SOF_LVL_SEL_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
pub struct BUS_RESET_LVL_SEL_R(crate::FieldReader<u8, u8>);
impl BUS_RESET_LVL_SEL_R {
    pub(crate) fn new(bits: u8) -> Self {
        BUS_RESET_LVL_SEL_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for BUS_RESET_LVL_SEL_R {
...
pub struct EP0_LVL_SEL_R(crate::FieldReader<u8, u8>);
impl EP0_LVL_SEL_R {
    pub(crate) fn new(bits: u8) -> Self {
        EP0_LVL_SEL_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for EP0_LVL_SEL_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct LPM_LVL_SEL_R(crate::FieldReader<u8, u8>);
impl LPM_LVL_SEL_R {
    pub(crate) fn new(bits: u8) -> Self {
        LPM_LVL_SEL_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for LPM_LVL_SEL_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct RESUME_LVL_SEL_R(crate::FieldReader<u8, u8>);
impl RESUME_LVL_SEL_R {
    pub(crate) fn new(bits: u8) -> Self {
        RESUME_LVL_SEL_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for RESUME_LVL_SEL_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct ARB_EP_LVL_SEL_R(crate::FieldReader<u8, u8>);
impl ARB_EP_LVL_SEL_R {
    pub(crate) fn new(bits: u8) -> Self {
        ARB_EP_LVL_SEL_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for ARB_EP_LVL_SEL_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct EP1_LVL_SEL_R(crate::FieldReader<u8, u8>);
impl EP1_LVL_SEL_R {
    pub(crate) fn new(bits: u8) -> Self {
        EP1_LVL_SEL_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for EP1_LVL_SEL_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct EP2_LVL_SEL_R(crate::FieldReader<u8, u8>);
impl EP2_LVL_SEL_R {
    pub(crate) fn new(bits: u8) -> Self {
        EP2_LVL_SEL_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for EP2_LVL_SEL_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct EP3_LVL_SEL_R(crate::FieldReader<u8, u8>);
impl EP3_LVL_SEL_R {
    pub(crate) fn new(bits: u8) -> Self {
        EP3_LVL_SEL_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for EP3_LVL_SEL_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct EP4_LVL_SEL_R(crate::FieldReader<u8, u8>);
impl EP4_LVL_SEL_R {
    pub(crate) fn new(bits: u8) -> Self {
        EP4_LVL_SEL_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for EP4_LVL_SEL_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct EP5_LVL_SEL_R(crate::FieldReader<u8, u8>);
impl EP5_LVL_SEL_R {
    pub(crate) fn new(bits: u8) -> Self {
        EP5_LVL_SEL_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for EP5_LVL_SEL_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct EP6_LVL_SEL_R(crate::FieldReader<u8, u8>);
impl EP6_LVL_SEL_R {
    pub(crate) fn new(bits: u8) -> Self {
        EP6_LVL_SEL_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for EP6_LVL_SEL_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct EP7_LVL_SEL_R(crate::FieldReader<u8, u8>);
impl EP7_LVL_SEL_R {
    pub(crate) fn new(bits: u8) -> Self {
        EP7_LVL_SEL_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for EP7_LVL_SEL_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct EP8_LVL_SEL_R(crate::FieldReader<u8, u8>);
impl EP8_LVL_SEL_R {
    pub(crate) fn new(bits: u8) -> Self {
        EP8_LVL_SEL_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for EP8_LVL_SEL_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
