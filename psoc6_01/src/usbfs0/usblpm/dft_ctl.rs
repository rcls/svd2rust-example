...
pub struct DDFT_OUT_SEL_R(crate::FieldReader<u8, DDFT_OUT_SEL_A>);
impl DDFT_OUT_SEL_R {
    pub(crate) fn new(bits: u8) -> Self {
        DDFT_OUT_SEL_R(crate::FieldReader::new(bits))
    }
...
impl core::ops::Deref for DDFT_OUT_SEL_R {
    type Target = crate::FieldReader<u8, DDFT_OUT_SEL_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
pub struct DDFT_IN_SEL_R(crate::FieldReader<u8, DDFT_IN_SEL_A>);
impl DDFT_IN_SEL_R {
    pub(crate) fn new(bits: u8) -> Self {
        DDFT_IN_SEL_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
impl core::ops::Deref for DDFT_IN_SEL_R {
    type Target = crate::FieldReader<u8, DDFT_IN_SEL_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
