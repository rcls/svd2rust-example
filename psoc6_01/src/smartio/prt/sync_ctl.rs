...
pub struct IO_SYNC_EN_R(crate::FieldReader<u8, u8>);
impl IO_SYNC_EN_R {
    pub(crate) fn new(bits: u8) -> Self {
        IO_SYNC_EN_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for IO_SYNC_EN_R {
...
pub struct CHIP_SYNC_EN_R(crate::FieldReader<u8, u8>);
impl CHIP_SYNC_EN_R {
    pub(crate) fn new(bits: u8) -> Self {
        CHIP_SYNC_EN_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CHIP_SYNC_EN_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
