...
(for LUTs 4, 5, 6, 7)."]
pub struct LUT_TR0_SEL_R(crate::FieldReader<u8, u8>);
impl LUT_TR0_SEL_R {
    pub(crate) fn new(bits: u8) -> Self {
        LUT_TR0_SEL_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for LUT_TR0_SEL_R {
...
(for LUTs 0, 1, 2, 3); io_data_in\\[7\\]
(for LUTs 4, 5, 6, 7)."]
pub struct LUT_TR1_SEL_R(crate::FieldReader<u8, u8>);
impl LUT_TR1_SEL_R {
    pub(crate) fn new(bits: u8) -> Self {
        LUT_TR1_SEL_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for LUT_TR1_SEL_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct LUT_TR2_SEL_R(crate::FieldReader<u8, u8>);
impl LUT_TR2_SEL_R {
    pub(crate) fn new(bits: u8) -> Self {
        LUT_TR2_SEL_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for LUT_TR2_SEL_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
