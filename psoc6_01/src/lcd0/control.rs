...
pub struct LS_EN_R(crate::FieldReader<bool, bool>);
impl LS_EN_R {
    pub(crate) fn new(bits: bool) -> Self {
        LS_EN_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for LS_EN_R {
...
pub struct HS_EN_R(crate::FieldReader<bool, bool>);
impl HS_EN_R {
    pub(crate) fn new(bits: bool) -> Self {
        HS_EN_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for HS_EN_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct LCD_MODE_R(crate::FieldReader<bool, LCD_MODE_A>);
impl LCD_MODE_R {
    pub(crate) fn new(bits: bool) -> Self {
        LCD_MODE_R(crate::FieldReader::new(bits))
    }
...
impl core::ops::Deref for LCD_MODE_R {
    type Target = crate::FieldReader<bool, LCD_MODE_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
pub struct OP_MODE_R(crate::FieldReader<bool, OP_MODE_A>);
impl OP_MODE_R {
    pub(crate) fn new(bits: bool) -> Self {
...
impl core::ops::Deref for OP_MODE_R {
    type Target = crate::FieldReader<bool, OP_MODE_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
pub struct BIAS_R(crate::FieldReader<u8, BIAS_A>);
impl BIAS_R {
...
impl core::ops::Deref for BIAS_R {
    type Target = crate::FieldReader<u8, BIAS_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
pub struct COM_NUM_R(crate::FieldReader<u8, u8>);
impl COM_NUM_R {
    pub(crate) fn new(bits: u8) -> Self {
        COM_NUM_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for COM_NUM_R {
...
pub struct LS_EN_STAT_R(crate::FieldReader<bool, bool>);
impl LS_EN_STAT_R {
    pub(crate) fn new(bits: bool) -> Self {
        LS_EN_STAT_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for LS_EN_STAT_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
