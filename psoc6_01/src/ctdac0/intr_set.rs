...
pub struct VDAC_EMPTY_SET_R(crate::FieldReader<bool, bool>);
impl VDAC_EMPTY_SET_R {
    pub(crate) fn new(bits: bool) -> Self {
        VDAC_EMPTY_SET_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for VDAC_EMPTY_SET_R {
