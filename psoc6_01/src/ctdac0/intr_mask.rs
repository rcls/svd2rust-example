...
#[doc = "Field `VDAC_EMPTY_MASK` reader - Mask bit for corresponding bit in interrupt request register."]
pub struct VDAC_EMPTY_MASK_R(crate::FieldReader<bool, bool>);
impl VDAC_EMPTY_MASK_R {
    pub(crate) fn new(bits: bool) -> Self {
        VDAC_EMPTY_MASK_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for VDAC_EMPTY_MASK_R {
...
#[doc = "Field `VDAC_EMPTY_MASK` writer - Mask bit for corresponding bit in interrupt request register."]
pub struct VDAC_EMPTY_MASK_W<'a> {
    w: &'a mut W,
}
impl<'a> VDAC_EMPTY_MASK_W<'a> {
...
impl R {
    ...
    #[inline(always)]
    pub fn vdac_empty_mask(&self) -> VDAC_EMPTY_MASK_R {
        VDAC_EMPTY_MASK_R::new((self.bits & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - Mask bit for corresponding bit in interrupt request register."]
    #[inline(always)]
    pub fn vdac_empty_mask(&mut self) -> VDAC_EMPTY_MASK_W {
        VDAC_EMPTY_MASK_W { w: self }
    }
