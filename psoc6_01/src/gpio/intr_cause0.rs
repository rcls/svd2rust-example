...
pub struct R(crate::R<INTR_CAUSE0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<INTR_CAUSE0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<INTR_CAUSE0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<INTR_CAUSE0_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Interrupt port cause register 0\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [intr_cause0](index.html) module"]
pub struct INTR_CAUSE0_SPEC;
impl crate::RegisterSpec for INTR_CAUSE0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [intr_cause0::R](R) reader structure"]
impl crate::Readable for INTR_CAUSE0_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets INTR_CAUSE0 to value 0"]
impl crate::Resettable for INTR_CAUSE0_SPEC {
    #[inline(always)]
