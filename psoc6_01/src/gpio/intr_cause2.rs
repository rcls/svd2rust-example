#[doc = "Register `INTR_CAUSE2` reader"]
pub struct R(crate::R<INTR_CAUSE2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<INTR_CAUSE2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<INTR_CAUSE2_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<INTR_CAUSE2_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Interrupt port cause register 2\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [intr_cause2](index.html) module"]
pub struct INTR_CAUSE2_SPEC;
impl crate::RegisterSpec for INTR_CAUSE2_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [intr_cause2::R](R) reader structure"]
impl crate::Readable for INTR_CAUSE2_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets INTR_CAUSE2 to value 0"]
impl crate::Resettable for INTR_CAUSE2_SPEC {
    #[inline(always)]
